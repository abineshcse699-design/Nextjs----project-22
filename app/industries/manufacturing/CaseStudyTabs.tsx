...
const MANUFACTURING_URL = "/industries/manufacturing";
const CASE_STUDY_BASE = MANUFACTURING_URL;
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={MANUFACTURING_URL} className="hover:text-[#3a3ff0]">
        Manufacturing
      </Link>
      <ChevronRight className="h-3.5 w-3.5" />
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our manufacturing experts.
        </p>
        <Link
          href={`${MANUFACTURING_URL}#connect`}
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          ...
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Explore how Starfii helps manufacturers connect plants, automate
            operations, and build a modern data and cloud foundation for
            smarter production.
          </p>
          <Link
            href={MANUFACTURING_URL}
