...
const INDUSTRY_URL = "/industries/health-care";
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={INDUSTRY_URL} className="hover:text-[#3a3ff0]">
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      <div className="rounded-2xl bg-white p-6">
        ...
        <dl className="mt-5 space-y-4">
          ...
          <div>
            <dt className="font-body text-[14px] text-slate-500">Capabilities</dt>
            <dd className="mt-2 flex flex-wrap gap-2">
              {study.capabilities.map((s) => (
                <span
                  key={s}
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our healthcare experts.
        </p>
        <Link
          href={`${INDUSTRY_URL}#connect`}
            ...
            <div className="mt-10">
              ...
              <section id="client" className="scroll-mt-28">
                ...
                <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3">
                  ...
                  <div>
                    <p className="font-heading text-[28px] font-medium leading-tight text-[#3a3ff0] lg:text-[32px]">
                      {study.capabilities.length} capabilities
                    </p>
                    <p className="font-body mt-2 text-[17px] leading-relaxed text-[#0b1747] lg:text-[18px]">
                      Capabilities
                    </p>
              ...
              <section id="solution" className="mt-20 scroll-mt-28">
                ...
                <Paragraphs items={[study.approach, study.solution]} />

                {study.phases && study.phases.length > 0 && (
                  <>
                    <h2 className={`${SUB_HEADING} mt-10`}>Our phased approach</h2>
                    <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                      {study.phases.map((phase) => (
                        ...
                        >
                          <p className="font-body text-[13px] font-bold tracking-[0.14em] text-[#3a3ff0]">
                            {phase.number}
                          </p>
                          <h3 className="font-heading mt-2 text-[20px] font-semibold leading-snug text-[#0b1747]">
                            {phase.title}
                          </h3>
                          <p className="font-body mt-2 text-[16px] leading-relaxed text-slate-600">
                            {phase.body}
                          </p>
                        </div>
                      ))}
              ...
              <section id="benefits" className="mt-20 scroll-mt-28">
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                  {study.benefits.map((benefit) => (
                    ...
                    >
                      <p className="font-body text-[16px] font-medium leading-relaxed text-[#0b1747]">
                        {benefit}
                      </p>
                    </div>
                  ))}
              ...
              <section id="summary" className="mt-20 scroll-mt-28">
                ...
                <h2 className={`${SUB_HEADING} mt-10`}>Capabilities Used</h2>
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          ...
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Explore how Starfii helps healthcare and life sciences
            organizations modernize platforms, unlock data, and deliver
            better digital experiences for patients and providers.
          </p>
          <Link
            href={INDUSTRY_URL}
