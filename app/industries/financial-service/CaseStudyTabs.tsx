...
/* ============================================================
   ROUTES
   No /casestudies listing page exists yet for Financial Services,
   so prev/next links point at case study detail pages, and the
   closing CTA / breadcrumb fall back to the anchor on the main
   Financial Services page. Update LIST_HREF once a listing page
   ships.
============================================================ */

const CASE_STUDY_BASE = "/industries/financial-services/casestudies";
const LIST_HREF = "/industries/financial-services#case-studies";

/* ============================================================
   TYPE SCALE (same as Banking / Cloud / Data & Analytics / Education)
============================================================ */
...
function PointList({ items }: { items: string[] }) {
  return (
    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
      {items.map((point, i) => (
        <div key={i} className="rounded-2xl bg-white px-6 py-5">
          <p className="font-body text-[16px] leading-relaxed text-[#0b1747]">
            {point}
          </p>
        </div>
      ))}
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={LIST_HREF} className="hover:text-[#3a3ff0]">
        Case Studies
      </Link>
      <ChevronRight className="h-3.5 w-3.5" />
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our financial services experts.
        </p>
        <Link
          href="/#contact"
...
/* ============================================================
   MAIN COMPONENT — owns the entire page, same design as
   Banking / Cloud / Data & Analytics / Education
============================================================ */
          ...
          <div className="min-w-0">
            ...
            <div className="mt-10">
              ...
              <section id="challenge" className="mt-20 scroll-mt-28">
                ...
                <Paragraphs items={[study.challengeIntro]} />
                <PointList items={study.challengePoints} />
              </section>

              {/* Solution */}
              <section id="solution" className="mt-20 scroll-mt-28">
                <SectionHeading>The Starfii Solution</SectionHeading>
                <Paragraphs items={[study.solutionIntro, study.solutionDetail]} />
                <PointList items={study.solution} />
              </section>

              {/* Benefits */}
              <section id="benefits" className="mt-20 scroll-mt-28">
                <SectionHeading>Benefits</SectionHeading>
                <Paragraphs items={[study.benefitsIntro]} />
                <PointList items={study.benefits} />
              </section>

              {/* Summary */}
              <section id="summary" className="mt-20 scroll-mt-28">
                <SectionHeading>Summary</SectionHeading>
                <TextCard text={study.summary} />
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          ...
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Let&apos;s discuss how Starfii can help your financial services
            team achieve results like these.
          </p>
          <Link
            href="/#contact"
