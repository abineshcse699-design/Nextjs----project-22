...
export async function generateMetadata({
  ...
  if (!study) {
    return {
      title: "Travel & Hospitality Case Study | Starfii",
      description:
        "Starfii travel and hospitality technology and digital transformation case study.",
    };
  }
...
export default async function TravelHospitalityCaseStudyPage({
  params,
}: PageProps) {
  const { slug } = await params;
