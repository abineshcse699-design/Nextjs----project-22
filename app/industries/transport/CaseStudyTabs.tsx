...
/* ============================================================
   ROUTES
   Must match the real folder name on disk ("transport").
   If you rename the folder (e.g. "transportation-logistics"),
   change ONLY the TL_URL line (and TL_BASE in ../page.tsx).
============================================================ */

const TL_URL = "/industries/transport";
const CASE_STUDY_BASE = TL_URL;
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={TL_URL} className="hover:text-[#3a3ff0]">
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our transportation and logistics experts.
        </p>
        <Link
          href={`${TL_URL}#connect`}
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          <h2 className="font-heading mt-2 text-[34px] font-medium leading-tight tracking-[-0.02em] text-white sm:text-[42px]">
            Building the future of transportation and logistics technology
          </h2>
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Explore how Starfii helps transportation and logistics
            organizations connect operations, gain real time visibility, and
            modernize the platforms that keep goods and people moving.
          </p>
          <Link
            href={TL_URL}
          ...
          >
            Explore Transportation &amp; Logistics Solutions
