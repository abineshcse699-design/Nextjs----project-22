...
export async function generateMetadata({
  ...
  if (!study) {
    return {
      title: "Transportation & Logistics Case Study | Starfii",
      description:
        "Starfii transportation and logistics technology and digital transformation case study.",
    };
  }
...
export default async function TransportLogisticsCaseStudyPage({
  params,
}: PageProps) {
  const { slug } = await params;
