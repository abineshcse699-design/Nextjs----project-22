...
const BANKING_URL = "/industries/banking";
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our banking experts.
        </p>
        <Link
          href="/#contact"
...
/* ============================================================
   MAIN COMPONENT — owns the entire page, same design as Cloud / Data & Analytics
============================================================ */
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          ...
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Explore how Starfii helps banks modernize technology, improve
            customer experiences, strengthen operations, and build secure
            digital platforms.
          </p>
          <Link
            href={BANKING_URL}
