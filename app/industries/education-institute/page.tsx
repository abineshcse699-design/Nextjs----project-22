//  Education & Institutions -- page  (/industries/education)
//  Same design system as the "Banking" page
//  (Champion Blue / Lavender / Indigo, light theme).

"use client";
import Link from "next/link";
import GetInTouch from "../education-institute/getintouch";
import {
  useRef,
  useState,
  useEffect,
...
---------------------------------------------------------------- */
const CASE_STUDY_BASE = "/industries/education-institute/casestudies";
const CAPABILITY_BASE = "/industries/education/capabilities";

/* ===============================================================
   CONTENT
   Page 23 — Education & Institutions  (/industries/education)
   282. Industry challenges   -> Hero + Key Takeaways + Q&A block
   283. Digital learning      -> Capability card + tab
   284. Education platforms   -> Capability card + tab
   285. Student experience    -> Capability card + tab
   286. Data and analytics    -> Capability card + tab
   287. AI                    -> Capability card + tab
   288. Application dev       -> Capability card + tab
   289. Cloud                 -> Capability card + tab
   290. Use cases             -> Use Cases accordion (dark)
   291. Case studies          -> Case Studies section
   292. CTA                   -> Closing CTA (GetInTouch)
================================================================ */
...
const faqs: Faq[] = [
  {
    question: "How does Starfii help education organizations modernize their digital learning?",
    answer:
      "Starfii creates accessible and engaging digital learning experiences across web, mobile, virtual classrooms, content, and assessments. Experience design and engineering work together, so learning technology becomes easier for students and faculty to use and easier for institutions to manage.",
  },
  {
    question: "What does an education platform from Starfii include?",
    answer:
      "Our education platforms connect students, faculty, administrators, content, workflows, and institutional systems. They are built on a modular architecture with secure integrations, so institutions can add new services and channels as needs grow without rebuilding the platform each time.",
  },
  {
    question: "How does Starfii improve the student experience?",
    answer:
      "We design connected journeys across discovery, admissions, onboarding, learning, campus services, communication, payments, and alumni engagement. Each journey is built to reduce friction and make important information easier to find and act on.",
  },
  {
    question: "How can data and analytics help education leaders make better decisions?",
    answer:
      "We bring institutional, student, learning, and operational data together on governed platforms. On top of that, we build reporting, dashboards, and analytics that give teams clearer visibility into performance, engagement, operations, and outcomes while maintaining appropriate data controls.",
  },
  {
    question: "How can AI be used responsibly in education?",
    answer:
      "Starfii applies AI to practical workflows such as knowledge assistance, content support, administrative automation, student communication, and document processing. Every solution is designed around responsible use, security, governance, and human oversight.",
  },
  {
    question: "Can Starfii modernize our existing education applications?",
    answer:
      "Yes. We design and engineer web and mobile applications for learning, administration, student services, and faculty workflows, and we modernize legacy applications in stages. Scalable architecture, APIs, testing, accessibility, and security are built into the delivery approach.",
  },
  {
    question: "How do you approach cloud migration for education organizations?",
    answer:
      "We plan staged migrations that start with the workloads where cloud delivers the most resilience and scalability. Architecture, observability, data controls, integrations, and governance are considered together, so digital services stay reliable while the institution modernizes.",
  },
  {
    question: "How can we get started with Starfii on an education technology initiative?",
    answer:
      "Reach out through the Connect Now button and our team will set up a discovery conversation to understand your priorities, current systems, and institutional needs. From there, we propose a phased roadmap with clear milestones, so you see value early and scale with confidence.",
  },
];
...
const keyTakeaways = [
  {
    title: "Modernize",
    body: "Starfii helps education organizations modernize digital learning, institutional platforms, and administration with secure, scalable technology built for connected education.",
  },
  {
    title: "Personalize",
    body: "We design student experiences, backed by data and analytics, so every journey from admissions to alumni engagement feels simple, accessible, and relevant.",
  },
  {
    title: "Scale",
    body: "Our capabilities span AI, application development, and cloud, with security and governance built in, so institutions reduce administrative effort while they keep pace with rising learner expectations.",
  },
];

/* --- 283–289. The seven education capabilities ------------------- */
...
const capabilities: Capability[] = [
  {
    ...
    body: "Starfii creates accessible and engaging digital learning experiences across web, mobile, virtual classrooms, content, and assessments.",
  },
  {
    slug: "education-platforms",
    title: "Education Platforms",
    body: "We build and modernize platforms that connect students, faculty, administrators, content, and institutional systems on a scalable foundation.",
  },
  {
    slug: "student-experience",
    title: "Student Experience",
    body: "We design connected journeys across admissions, onboarding, learning, campus services, and alumni engagement, cutting friction at every step.",
  },
  {
    slug: "data-and-analytics",
    title: "Data and Analytics",
    body: "We bring institutional, student, and operational data into governed platforms, so teams can act on clear insight into performance and outcomes.",
  },
  {
    slug: "ai",
    title: "AI",
    body: "Starfii applies AI to knowledge assistance, administrative automation, and student services, with governance and human oversight built in.",
  },
  {
    slug: "application-development",
    title: "Application Development",
    body: "We design and engineer web and mobile applications for learning, administration, and student services with accessibility and security built in.",
  },
  {
    slug: "cloud",
    title: "Cloud",
    body: "Starfii helps education organizations modernize workloads in secure cloud environments, improving resilience and scalability of digital services.",
  },
];
...
const useCases: UseCase[] = [
  {
    ...
    body: "Create connected admissions journeys across applications, document collection, communication, status tracking, and onboarding for prospective and newly admitted students.",
  },
  {
    title: "Learning Experience Platforms",
    body: "Modernize learning platforms with accessible experiences, digital content, assessments, collaboration, communication, and integrations with institutional systems.",
  },
  {
    title: "Student Portals",
    body: "Give students a central digital experience for schedules, services, forms, payments, communication, academic information, and important institutional tasks.",
  },
  {
    title: "Institutional Analytics",
    body: "Connect student, academic, operational, and engagement data for reporting, dashboards, analytics, and decision support across the institution.",
  },
  {
    title: "Administrative Automation",
    body: "Automate repetitive workflows across document handling, approvals, communications, service requests, reporting, and administrative operations.",
  },
  {
    title: "Virtual and Hybrid Learning",
    body: "Connect digital classrooms, content, collaboration, communication, and supporting services to deliver consistent learning experiences across locations and formats.",
  },
];
...
const caseStudies: CaseStudy[] = [
  {
    ...
    body: "A digital modernization program improved student-facing journeys while creating a more scalable foundation for institutional services.",
  },
  {
    ...
    body: "Application engineering and integration capabilities connected learning, administration, and digital services around a stronger platform foundation.",
  },
  {
    ...
    body: "A data modernization approach brought fragmented education information together to improve reporting, insight, and operational visibility.",
  },
];
              ...
              <Reveal key={item.title} delay={index * 80}>
                ...
                >
                  <button
                    ...
                    aria-controls={`edu-usecase-panel-${index}`}
          ...
          <Reveal key={faq.question} delay={(i % 5) * 70}>
            ...
            >
              ...
              <div
                id={`edu-faq-panel-${i}`}
                role="region"
                aria-labelledby={`edu-faq-button-${i}`}
                className="ss-eco-panel grid transition-all duration-500 ease-out"
                style={{ gridTemplateRows: isOpen ? "1fr" : "0fr" }}
              >
                <div className="overflow-hidden">
...
export default function EducationPage(): ReactElement {
  ...
  return (
    <main className="bg-white">
        ...
        <div className={`${ALIGN} relative flex min-h-[460px] items-center lg:min-h-[620px]`}>
          <div className="w-full max-w-[760px] py-10 lg:py-12">
            ...
            >
              ...
              <ChevronRight size={14} />
              <span className="text-white/60">Education &amp; Institutions</span>
            </nav>
            ...
            >
              Education &amp; Institutions Technology Solutions
            </h1>
            ...
            >
              Digital learning, administration and institutional technology
      ...
      <div className={ALIGN}>
        ...
        <Reveal as="section" className="mt-16">
          ...
          >
            ...
            platforms, and operations with secure, data driven technology, so
            they can deliver better student experiences while meeting the
            demands of connected education.
          </p>
        </Reveal>

        {/* ============================================================
            Q&A BLOCK  (282. Industry challenges)
        ============================================================ */}
           ...
           <div className="group grid grid-cols-1 items-stretch overflow-hidden rounded-[20px] bg-[#F5F3FC] transition-colors duration-500 ease-out hover:bg-[#EAE4FA] lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-10 transition-transform duration-500 ease-out group-hover:translate-x-2 lg:p-14">
              <h2
                ...
                style={{ color: CHAMPION_BLUE }}
              >
                {"What Challenges Do Education Organizations Face in Modernizing Their Technology?"}
              </h2>

              <p className="font-body mt-5 text-[17px] leading-relaxed text-slate-600 lg:text-[18px]">
                Education organizations balance changing learner
                expectations, digital and hybrid learning needs, complex
                administration, fragmented data, and legacy applications, all
                while delivering accessible and secure digital services.
                Starfii connects digital learning, education platforms,
                student experience, data and analytics, AI, application
                development, and cloud into one modernization approach.
              </p>
            </div>
      ...
      {/* ============================================================
          CAPABILITIES  (283–289. Digital learning through Cloud)
      ============================================================ */}
      <section
        id="capabilities"
        ...
        <div className={`relative ${ALIGN}`}>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              {/* <Eyebrow variant="light">Education &amp; Institutions</Eyebrow> */}
              ...
              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                Starfii connects learning, student services, institutional
                operations, data, AI, applications, and cloud through a
                unified digital foundation, so education organizations can
      ...
      <div className={ALIGN}>
        {/* ============================================================
            TABBED DEEP-DIVE  (283–289)
        ============================================================ */}
        <Reveal as="section" className="mt-24 pb-28">
          {/* <Eyebrow>Education &amp; Institutions</Eyebrow> */}
          <h2
      ...
      {/* ============================================================
          USE CASES (dark)  (290. Use cases) — click "+" to expand
      ============================================================ */}
