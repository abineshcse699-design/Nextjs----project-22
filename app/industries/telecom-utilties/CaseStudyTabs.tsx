...
/* ============================================================
   ROUTES
   Must match the real folder name on disk ("telecom-utilties").
   If you rename the folder to "telecom-utilities", change ONLY
   the TU_URL line (and TU_BASE in ../page.tsx).
============================================================ */

const TU_URL = "/industries/telecom-utilties";
const CASE_STUDY_BASE = TU_URL;
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={TU_URL} className="hover:text-[#3a3ff0]">
        Telecom &amp; Utilities
      </Link>
      <ChevronRight className="h-3.5 w-3.5" />
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our telecom and utilities experts.
        </p>
        <Link
          href={`${TU_URL}#connect`}
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          <h2 className="font-heading mt-2 text-[34px] font-medium leading-tight tracking-[-0.02em] text-white sm:text-[42px]">
            Building the future of telecom and utilities technology
          </h2>
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Explore how Starfii helps telecom and utilities providers modernize
            networks, digital platforms, and operations for a more connected,
          ...
          >
            Explore Telecom &amp; Utilities Solutions
