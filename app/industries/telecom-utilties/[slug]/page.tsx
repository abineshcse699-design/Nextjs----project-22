...
export async function generateMetadata({
  ...
  if (!study) {
    return {
      title: "Telecom & Utilities Case Study | Starfii",
      description:
        "Starfii telecom and utilities technology and digital transformation case study.",
    };
  }
...
export default async function TelecomUtilitiesCaseStudyPage({
  params,
}: PageProps) {
  const { slug } = await params;
