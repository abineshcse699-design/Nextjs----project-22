//  Telecom & Utilities -- page  (/industries/telecom-utilities)
//  Exact same design system + layout as the Banking page
//  (Champion Blue / Lavender / Indigo, light theme).

"use client";
import Link from "next/link";
// NOTE: same import path as your existing telecom-utilities page.
import GetInTouch from "../telecom-utilties/getintouch";
import {
  useRef,
  useState,
  useEffect,
...
---------------------------------------------------------------- */
// const CASE_STUDY_BASE = "/industries/telecom-utilties/casestudies";
// const CAPABILITY_BASE = "/industries/telecom-utilities/capabilities";



// Must match the real folder name on disk (your folder = "telecom-utilties")
const TU_BASE = "/industries/telecom-utilties";
const CASE_STUDY_BASE = TU_BASE;
const CASE_STUDY_LIST = `${TU_BASE}#case-studies`;
const CAPABILITY_BASE = `${TU_BASE}/capabilities`;

/* ===============================================================
   CONTENT
   Page 28 — Telecom & Utilities  (/industries/telecom-utilities)
   339. Industry challenges     -> Hero + Key Takeaways + Q&A block
   340. Customer platforms      -> Capability card + tab
   341. Digital operations      -> Capability card + tab
   342. Data                    -> Capability card + tab
   343. AI                      -> Capability card + tab
   344. Automation              -> Capability card + tab
   345. Cloud                   -> Capability card + tab
   346. Application engineering -> Capability card + tab
   347. Use cases               -> Use Cases accordion (dark)
   348. Case studies            -> Case Studies section
   349. FAQ                     -> FAQ section
   350. CTA                     -> Closing CTA (GetInTouch)
================================================================ */
...
const faqs: Faq[] = [
  {
    question:
      "How does Starfii help telecom and utility providers modernize customer platforms?",
    answer:
      "Starfii connects self-service, account management, service requests, communications, and billing into a single modular customer platform. We wrap legacy systems with APIs and roll out improvements in stages, so account and billing operations keep running without interruption.",
  },
  {
    question:
      "What does digital operations modernization from Starfii include?",
    answer:
      "Our digital operations work covers network, field service, workforce, asset, and customer operations, connected through digital workflows and mobile tools. Field teams get scheduling, work orders, and asset information in one place instead of switching between disconnected systems.",
  },
  {
    question:
      "How can AI support network and asset intelligence without adding operational risk?",
    answer:
      "Starfii applies AI to forecasting, network and asset insights, and knowledge discovery, with governance and human oversight built into every workflow. This keeps recommendations explainable and auditable, which matters for infrastructure and service reliability.",
  },
  {
    question:
      "How does automation reduce manual work in telecom and utility operations?",
    answer:
      "We automate provisioning, approvals, notifications, exception handling, and billing workflows so routine steps no longer require manual intervention. Automations are designed to escalate exceptions to the right team, keeping people in control of decisions that need judgment.",
  },
  {
    question:
      "How do data platforms help telecom and utility businesses make better decisions?",
    answer:
      "Starfii brings customer, network, asset, service, and usage data together into governed data platforms and reporting. This gives operations and customer teams a trusted, near real time view of performance, demand, and service health.",
  },
  {
    question:
      "How do you approach cloud modernization for infrastructure-heavy organizations?",
    answer:
      "We plan staged migrations that prioritize the workloads where cloud delivers the most resilience and scalability, with observability built in from the start. Landing zones and failover patterns are designed to support continuous service delivery throughout the migration.",
  },
  {
    question:
      "How does Starfii approach application engineering across telecom and utility ecosystems?",
    answer:
      "We design, build, modernize, integrate, test, and operate applications that connect customers, employees, assets, and operational platforms. Legacy applications are modernized incrementally, with new and existing components running side by side until each step is validated.",
  },
  {
    question:
      "How can we get started with Starfii on a telecom or utilities technology initiative?",
    answer:
...
const keyTakeaways = [
  {
    title: "Modernize",
    body: "Starfii helps telecom and utility businesses modernize customer platforms, applications, and operations with secure, scalable technology built for resilient, always-on service.",
  },
  {
    title: "Connect",
    body: "We connect customers, field teams, assets, and operational data through digital platforms and analytics, so every service journey from a support request to a field visit feels coordinated and reliable.",
  },
  {
    title: "Automate",
    body: "Our capabilities span AI, automation, cloud, and application engineering, so providers reduce manual effort and operational risk while they keep pace with rising customer expectations.",
  },
];

/* --- 340–346. The seven telecom & utilities capabilities -------- */
...
const capabilities: Capability[] = [
  {
    ...
    body: "Starfii builds digital customer platforms that connect self-service, account management, service requests, communications, billing experiences, and support across web and mobile.",
  },
  {
    slug: "digital-operations",
    title: "Digital Operations",
    body: "We modernize operational workflows across network, field service, service management, workforce, asset, and customer operations with connected digital experiences.",
  },
  {
    slug: "data",
    title: "Data",
    body: "Starfii brings customer, network, asset, service, usage, and operational data together through governed data platforms, reporting, and analytics.",
  },
  {
    slug: "ai",
    title: "AI",
    body: "We apply AI to customer assistance, network and asset insights, forecasting, knowledge discovery, and service operations with responsible governance.",
  },
  {
    slug: "automation",
    title: "Automation",
    body: "Starfii automates repetitive workflows across service requests, provisioning, field operations, billing, approvals, notifications, and exception handling.",
  },
  {
    slug: "cloud",
    title: "Cloud",
    body: "We modernize applications and workloads with secure cloud architecture, scalable services, integrations, observability, resilience, and governance.",
  },
  {
    slug: "application-engineering",
    title: "Application Engineering",
    body: "Starfii designs, builds, modernizes, integrates, tests, and operates applications that connect customers, employees, assets, services, and operational platforms.",
  },
];
...
const tabs: ServiceTab[] = [
  {
    ...
    heading: "Connected customer platforms for telecom and utilities",
    body: "Starfii builds digital customer platforms that connect self-service, account management, service requests, communications, billing experiences, and support across web and mobile channels. A modular architecture lets providers add new services and channels as demand grows, without rebuilding the platform each time.",
    image:
  ...
  },
  {
    ...
    heading: "Digital operations for connected and resilient service delivery",
    body: "Starfii modernizes operational workflows across network, field service, service management, workforce, asset, and customer operations with connected digital experiences. Teams get the information they need in one place, so work moves faster and service stays reliable.",
    image:
  ...
  },
  {
    id: "data",
    label: "Data",
    heading: "Data foundations that connect operational and customer intelligence",
    body: "Starfii brings customer, network, asset, service, usage, and operational data together through governed data platforms, reporting, analytics, and decision-support capabilities. Operations and customer teams gain a clearer view of performance, demand, and service health, and act on it faster.",
    image:
  ...
  },
  {
    id: "ai",
    label: "AI",
    heading: "AI for smarter telecom and utility experiences",
    body: "Starfii applies AI to customer assistance, network and asset insights, forecasting, knowledge discovery, document processing, service operations, and decision support. Governance and human oversight are built in, so recommendations stay explainable and trusted.",
    image:
  ...
  },
  {
    id: "automation",
    label: "Automation",
    heading: "Automation that simplifies complex service operations",
    body: "Starfii automates repetitive workflows across service requests, provisioning, field operations, billing processes, approvals, notifications, exception handling, and back-office operations. Exceptions are routed to the right team, keeping people in control of decisions that need judgment.",
    image:
  ...
  },
  {
    id: "cloud",
    label: "Cloud",
    heading: "Cloud foundations for resilient digital infrastructure",
    body: "Starfii modernizes applications and workloads with secure cloud architecture, scalable services, integrations, observability, resilience, data foundations, and governance. Providers modernize step by step while daily service delivery keeps running.",
    image:
  ...
  },
  {
    ...
    heading: "Application engineering for connected telecom and utility ecosystems",
    body: "Starfii designs, builds, modernizes, integrates, tests, and operates applications that connect customers, employees, assets, services, data, and operational platforms. Legacy applications are modernized incrementally, with old and new components running side by side until each step is validated.",
    image:
...
const useCases: UseCase[] = [
  {
    ...
    body: "Create connected web and mobile experiences for account management, service requests, payments, support, communications, and self-service journeys.",
  },
  {
    title: "Field Service Operations",
    body: "Connect field teams with scheduling, work orders, asset information, service history, mobile workflows, communications, and operational updates.",
  },
  {
    title: "Network and Asset Intelligence",
    body: "Bring operational data together with analytics and AI to support asset visibility, monitoring, forecasting, maintenance, and decision support.",
  },
  {
    title: "Service Workflow Automation",
    body: "Automate provisioning, approvals, notifications, exception handling, service requests, billing workflows, and repetitive operational processes.",
  },
  {
    title: "AI Enabled Customer Support",
    body: "Introduce responsible AI capabilities for customer assistance, knowledge discovery, intelligent search, recommendations, and service workflows.",
  },
  {
    title: "Application and Cloud Modernization",
    body: "Modernize critical applications and technology foundations while improving scalability, resilience, integration, observability, and operational control.",
  },
];
...
/* ===============================================================
   ...
   Swap in telecom-utilities specific slugs once they exist.
================================================================ */
...
const caseStudies: CaseStudy[] = [
  {
    ...
    body: "A digital modernization program connected customer journeys, service workflows, applications, and data around a scalable platform foundation.",
  },
  {
    ...
    body: "Operational workflows, automation, and application engineering helped connect teams, assets, information, and service processes.",
  },
  {
    ...
    body: "Cloud engineering and data capabilities created a stronger foundation for operational visibility, intelligent services, and scalable applications.",
  },
  {
    ...
    body: "Discover how Starfii's Generative AI and LLM engineering team embedded AI features into a compliance-driven service platform.",
  },
  {
              ...
              <Reveal key={item.title} delay={index * 80}>
                ...
                >
                  <button
                    ...
                    aria-controls={`tu-usecase-panel-${index}`}
          ...
          <Reveal key={faq.question} delay={(i % 5) * 70}>
            ...
            >
              ...
              <div
                id={`tu-faq-panel-${i}`}
                role="region"
                aria-labelledby={`tu-faq-button-${i}`}
                className="ss-eco-panel grid transition-all duration-500 ease-out"
                style={{ gridTemplateRows: isOpen ? "1fr" : "0fr" }}
              >
                <div className="overflow-hidden">
...
export default function TelecomUtilitiesSection(): ReactElement {
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative isolate min-h-[460px] overflow-hidden lg:min-h-[620px]">
        <div className="absolute inset-0 -z-10">
          <img
            ...
            alt="Telecom and utilities digital infrastructure"
            loading="eager"
            decoding="async"
            fetchPriority="high"
        ...
        <div className={`${ALIGN} relative flex min-h-[460px] items-center lg:min-h-[620px]`}>
          <div className="w-full max-w-[760px] py-10 lg:py-12">
            ...
            >
              ...
              <ChevronRight size={14} />
              <span className="text-white/60">Telecom &amp; Utilities</span>
            </nav>
            ...
            >
              Telecom &amp; Utilities Technology Solutions
            </h1>
            ...
            >
              Resilient digital platforms and intelligent operations for
              connected telecom and utility businesses.
            </p>
      ...
      <div className={ALIGN}>
        ...
        <Reveal as="section" className="mt-16">
          ...
          <p
            ...
            style={{ color: CHAMPION_BLUE }}
          >
            Starfii helps telecom and utility businesses modernize customer
            platforms, applications, and operations with resilient, data
            driven technology, so they can deliver better customer
            experiences while keeping essential services running reliably.
          </p>
        </Reveal>

        {/* ============================================================
            Q&A BLOCK  (339. Industry challenges)
        ============================================================ */}
          ...
          <div className="group grid grid-cols-1 items-stretch overflow-hidden rounded-lg bg-[#F5F3FC] transition-colors duration-500 ease-out hover:bg-[#EAE4FA] lg:grid-cols-2">
            <div className="flex flex-col justify-center p-10 transition-transform duration-500 ease-out group-hover:translate-x-2 lg:p-14">
              <h2
                ...
                style={{ color: CHAMPION_BLUE }}
              >
                {"What Challenges Do Telecom and Utility Businesses Face in Modernizing Their Technology?"}
              </h2>

              <p className="font-body mt-5 text-[17px] leading-relaxed text-slate-600 lg:text-[18px]">
                Telecom and utility businesses balance growing customer
                expectations, complex operational environments, connected
                assets, increasing data volumes, and resilience requirements,
                all while maintaining reliable service. Starfii addresses
                these together with customer platforms, digital operations,
                data, AI, automation, cloud, and application engineering.
              </p>
            </div>
            ...
            <div className="relative min-h-[320px] overflow-hidden">
              <img
                ...
                alt="Connected digital infrastructure for telecom and utilities"
                loading="lazy"
                decoding="async"
      ...
      {/* ============================================================
          CAPABILITIES  (340–346. Customer platforms through Application engineering)
      ============================================================ */}
      <section
        id="capabilities"
          ...
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              <h2
                ...
                style={{ color: CHAMPION_BLUE }}
              >
                {"Our Telecom & Utilities Technology Capabilities"}
              </h2>

              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                Starfii covers the full telecom and utilities technology
                landscape, from customer platforms and digital operations to
                data, AI, automation, and cloud, so providers can modernize
                with confidence.
              </p>
            </Reveal>
      ...
      {/* ============================================================
          USE CASES (dark)  (347. Use cases) — click "+" to expand
      ============================================================ */}
          ...
          <Reveal className="flex items-center justify-between">
            <div>
              <h2 className={`${SECTION_HEADING} mt-4`} style={{ color: CHAMPION_BLUE }}>
                Telecom &amp; Utilities Case Studies
              </h2>
            </div>
      ...
      {/* ============================================================
          FAQ  (349. Frequently Asked Questions)
      ============================================================ */}
      <section
        id="faq"
      ...
      {/* ============================================================
          350 — CTA  (id="connect" so the hero button scrolls here)
      ============================================================ */}
