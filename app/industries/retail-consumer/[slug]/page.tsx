...
export async function generateMetadata({
  ...
  if (!study) {
    return {
      title: "Retail & Consumer Case Study | Starfii",
      description:
        "Starfii retail and consumer technology and digital transformation case study.",
    };
  }
...
export default async function RetailConsumerCaseStudyPage({
  params,
}: PageProps) {
  const { slug } = await params;
