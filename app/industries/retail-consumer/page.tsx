//  Retail & Consumer -- page  (/industries/retail-consumer)
...
import GetInTouch from "../retail-consumer/getintouch";
import {
  useRef,
  useState,
  useEffect,
...
---------------------------------------------------------------- */
// const CASE_STUDY_BASE = "/industries/retail-consumer/casestudies";
// const CAPABILITY_BASE = "/industries/retail-consumer/capabilities";

const RC_BASE = "/industries/retail-consumer"; // must match your folder name
const CASE_STUDY_BASE = RC_BASE;
const CASE_STUDY_LIST = `${RC_BASE}#case-studies`;
const CAPABILITY_BASE = `${RC_BASE}/capabilities`;

/* ===============================================================
   CONTENT
   Page 22 — Retail & Consumer  (/industries/retail-consumer)
   270. Retail challenges     -> Hero + Key Takeaways + Q&A block
   271. E-commerce            -> Capability card + tab
   272. Customer experience   -> Capability card + tab
   273. Digital commerce      -> Capability card + tab
   274. Personalization       -> Capability card + tab
   275. AI                    -> Capability card + tab
   276. Data and analytics    -> Capability card + tab
   277. Supply chain          -> Capability card + tab
   278. Mobile and web        -> Capability card + tab
   279. Use cases             -> Use Cases accordion (dark)
   280. Case studies          -> Case Studies section
   281. CTA                   -> Closing CTA (GetInTouch)
================================================================ */
...
const faqs: Faq[] = [
  {
    question:
      "How does Starfii help retailers modernize their commerce platforms without disrupting sales?",
    answer:
      "Starfii modernizes commerce platforms in phases instead of a single big bang replacement. We use an API first approach, move capabilities in priority order, and run old and new components side by side until each step is validated. This keeps storefronts and orders running, including through peak periods, while the business moves to a more flexible, scalable foundation.",
  },
  {
    question: "What does a digital commerce platform from Starfii include?",
    answer:
      "Our digital commerce platforms cover catalog, search, pricing, promotions, carts, checkout, payments, order management, and the integrations behind them. They are built on a modular architecture, so retailers can add new products, channels, and experiences as demand grows without rebuilding the platform each time.",
  },
  {
    question: "How does Starfii create consistent customer experiences across channels?",
    answer:
      "Starfii designs connected experiences across stores, websites, mobile apps, service channels, loyalty, and post purchase journeys. Customer data and digital workflows work together, so customers can move between channels with less friction and the same context follows them.",
  },
  {
    question: "How can retailers use personalization while respecting customer data?",
    answer:
      "We help retailers use customer and behavioral data to power relevant product discovery, recommendations, offers, and content across digital touchpoints. Personalization is designed with data governance and consent in mind, so experiences feel helpful while customer trust stays intact.",
  },
  {
    question: "How can AI be used in retail and consumer businesses?",
    answer:
      "Starfii applies AI to areas such as recommendations, search, customer service, content assistance, demand insights, and operational decision support. Every solution is built around measurable outcomes, governance, and human oversight, so results can be reviewed and trusted by the teams who rely on them.",
  },
  {
    question: "How do data and analytics help retailers make better decisions?",
    answer:
      "We connect customer, product, commerce, store, inventory, and operational data into governed platforms. On top of that, we build dashboards and analytics that give teams a trusted, near real time view of customer behavior, channel performance, product trends, and business outcomes.",
  },
  {
    question: "How does Starfii improve inventory and supply chain visibility for retail?",
    answer:
      "We connect inventory, suppliers, orders, logistics, fulfillment, and commerce systems into one view. Digital workflows and analytics help retail teams coordinate stock and respond to changing customer demand sooner.",
  },
  {
    question:
      "How can we get started with Starfii on a retail and consumer technology initiative?",
    answer:
      "Reach out through the Connect Now button and our team will set up a discovery conversation to understand your priorities, current systems, and customer needs. From there, we propose a phased roadmap with clear milestones, so you see value early and scale with confidence.",
  },
];
...
const keyTakeaways = [
  {
    title: "Modernize",
    body: "Starfii helps retail and consumer businesses modernize digital storefronts, commerce platforms, and operations with secure, scalable technology built to move quickly.",
  },
  {
    title: "Personalize",
    body: "We engineer connected customer experiences, backed by data, AI, and personalization, so every journey from discovery to post purchase feels relevant, fast, and consistent across channels.",
  },
  {
    title: "Connect",
    body: "Our capabilities span analytics, supply chain technology, and mobile and web, so retailers connect customers, inventory, and channels while they keep pace with changing expectations.",
  },
];

/* --- 271–278. The eight retail capabilities --------------------- */
...
const capabilities: Capability[] = [
  {
    slug: "e-commerce",
    title: "E-Commerce",
    body: "Starfii modernizes digital storefronts, product discovery, checkout, and payments into commerce journeys that are fast, accessible, and ready to scale.",
  },
  {
    slug: "customer-experience",
    title: "Customer Experience",
    body: "We design connected experiences across stores, web, mobile, service, and loyalty, reducing friction and keeping every touchpoint consistent.",
  },
  {
    slug: "digital-commerce",
    title: "Digital Commerce",
    body: "Starfii builds and modernizes catalog, search, pricing, checkout, and order management on an API first architecture that evolves without disruption.",
  },
  {
    slug: "personalization",
    title: "Personalization",
    body: "We use customer and behavioral data to power relevant recommendations, offers, and content across digital touchpoints, with data governance built in.",
  },
  {
    slug: "ai",
    title: "AI",
    body: "Starfii applies AI to recommendations, search, customer service, and demand insights, with measurable outcomes and responsible use in mind.",
  },
  {
    slug: "data-and-analytics",
    title: "Data and Analytics",
    body: "We connect customer, product, commerce, and inventory data into governed platforms, so teams can act on behavior, channel, and product insight quickly.",
  },
  {
    slug: "supply-chain",
    title: "Supply Chain",
    body: "We connect inventory, suppliers, orders, and fulfillment systems for end to end visibility, helping retail teams respond to changing demand.",
  },
  {
    slug: "mobile-and-web",
    title: "Mobile and Web",
    body: "Starfii engineers responsive web platforms and mobile experiences that connect customers with products, loyalty, support, and commerce.",
  },
];
...
const tabs: ServiceTab[] = [
  {
    id: "e-commerce",
    label: "E-Commerce",
    heading: "E-commerce experiences built to convert and scale",
    body: "Starfii helps retailers modernize digital storefronts, product discovery, checkout, account experiences, payments, and supporting integrations. We combine experience design and engineering to create commerce journeys that are fast, connected, accessible, and ready to scale.",
    image:
  ...
  },
  {
    ...
    heading: "Customer experiences connected across every retail touchpoint",
    body: "We design connected experiences across stores, websites, mobile apps, service channels, loyalty, and post purchase journeys. Customer data and digital workflows work together to reduce friction and create consistent experiences across channels.",
    image:
  ...
  },
  {
    ...
    heading: "Digital commerce platforms for modern retail businesses",
    body: "Starfii builds and modernizes digital commerce capabilities across catalog, search, pricing, promotions, carts, checkout, payments, order management, and integrations. API first architecture helps retailers evolve their commerce ecosystem without unnecessary disruption.",
    image:
  ...
  },
  {
    ...
    heading: "Personalized journeys powered by customer context and data",
    body: "We help retailers use customer and behavioral data to create more relevant product discovery, recommendations, offers, content, and journeys. Personalization capabilities are designed to work across digital touchpoints while respecting data and experience requirements.",
    image:
      "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?q=80&w=1200&auto=format&fit=crop",
  },
  {
    id: "ai",
    label: "AI",
    heading: "AI for smarter retail experiences and operations",
    body: "Starfii applies AI to practical retail workflows including recommendations, search, customer service, content assistance, demand insights, document processing, and operational decision support. Solutions are designed around measurable outcomes, governance, and responsible use.",
    image:
  ...
  },
  {
    ...
    heading: "Retail data and analytics that turn signals into action",
    body: "We connect customer, product, commerce, store, inventory, and operational data into governed analytics foundations. Dashboards and advanced analytics help teams understand customer behavior, channel performance, product trends, and business outcomes.",
    image:
  ...
  },
  {
    id: "supply-chain",
    label: "Supply Chain",
    heading: "Connected supply chain technology for retail visibility",
    body: "We connect inventory, suppliers, orders, logistics, fulfillment, and commerce systems to improve end to end visibility. Digital workflows and analytics help retail teams coordinate inventory and respond to changing customer demand.",
    image:
  ...
  },
  {
    ...
    heading: "Mobile and web experiences designed for every screen",
    body: "Starfii designs and engineers responsive web platforms and mobile experiences that connect customers with products, services, loyalty, support, and commerce. Performance, accessibility, security, and maintainability are built into the delivery approach.",
    image:
...
const useCases: UseCase[] = [
  {
    title: "Digital Storefront Modernization",
    body: "Give shoppers a faster storefront. Starfii modernizes product discovery, search, catalog, checkout, payments, and supporting commerce integrations for a smoother digital experience.",
  },
  {
    title: "Omnichannel Customer Journeys",
    body: "Let customers move freely. Starfii connects web, mobile, stores, service, loyalty, and post purchase interactions, so customers switch channels with less friction.",
  },
  {
    title: "Personalized Commerce",
    body: "Show the right thing at the right time. Starfii uses customer context, behavioral signals, and product data to support relevant recommendations, content, offers, and discovery.",
  },
  {
    title: "Retail Analytics",
    body: "Turn data into direction. Starfii brings commerce, customer, inventory, product, and operational data together for dashboards, reporting, insights, and decision support.",
  },
  {
    title: "AI Powered Customer Service",
    body: "Resolve more, sooner. Starfii automates routine customer questions and service workflows, and gives teams relevant context and clear escalation paths for complex cases.",
  },
  {
    title: "Inventory and Supply Chain Visibility",
    body: "Stay ahead of demand. Starfii connects inventory, orders, suppliers, fulfillment, and logistics data to improve visibility and speed up responses to demand changes.",
  },
];
...
const caseStudies: CaseStudy[] = [
  {
    ...
    body: "A digital modernization program improved customer journeys while creating a more scalable foundation for commerce and digital experiences.",
  },
  {
    ...
    body: "Application engineering and integration capabilities helped evolve a commerce ecosystem around modular, connected digital services.",
  },
  {
    ...
    body: "A data modernization approach connected fragmented retail information to create stronger reporting, analytics, and operational visibility.",
  },
];
/* ===============================================================
   GLOBAL KEYFRAMES
              ...
              <Reveal key={item.title} delay={index * 80}>
                ...
                >
                  <button
                    ...
                    aria-controls={`rc-usecase-panel-${index}`}
          ...
          <Reveal key={faq.question} delay={(i % 5) * 70}>
            ...
            >
              ...
              <div
                id={`rc-faq-panel-${i}`}
                role="region"
                aria-labelledby={`rc-faq-button-${i}`}
                className="ss-eco-panel grid transition-all duration-500 ease-out"
                style={{ gridTemplateRows: isOpen ? "1fr" : "0fr" }}
              >
                <div className="overflow-hidden">
...
export default function RetailConsumerSection(): ReactElement {
  ...
  // Deep links such as ...#personalization open that tab
  useEffect(() => {
  ...
  return (
    <main className="bg-white">
      ...
      {/* ============================================================
          HERO  (270. Retail challenges)
      ============================================================ */}
      <section className="relative isolate min-h-[460px] overflow-hidden lg:min-h-[620px]">
        <div className="absolute inset-0 -z-10">
          <img
            src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=85&w=2000&auto=format&fit=crop"
        ...
        <div className={`${ALIGN} relative flex min-h-[460px] items-center lg:min-h-[620px]`}>
          <div className="w-full max-w-[760px] py-10 lg:py-12">
            ...
            >
              ...
              <ChevronRight size={14} />
              <span className="text-white/60">Retail &amp; Consumer</span>
            </nav>
            ...
            >
              Retail &amp; Consumer Technology Solutions
            </h1>
            ...
            >
              Connected customer experiences and intelligent digital commerce
              platforms for retail and consumer businesses.
            </p>
      ...
      <div className={ALIGN}>
        ...
        <Reveal as="section" className="mt-16">
          ...
          <p
            ...
            style={{ color: CHAMPION_BLUE }}
          >
            Starfii helps retail and consumer businesses connect commerce,
            customer experience, and data, modernizing platforms and
            operations so they can deliver seamless experiences across every
            channel.
          </p>
        </Reveal>

        {/* ============================================================
            Q&A BLOCK  (270. Retail challenges)
        ============================================================ */}
          ...
          <div className="group grid grid-cols-1 items-stretch overflow-hidden rounded-lg bg-[#F5F3FC] transition-colors duration-500 ease-out hover:bg-[#EAE4FA] lg:grid-cols-2">
            <div className="flex flex-col justify-center p-10 transition-transform duration-500 ease-out group-hover:translate-x-2 lg:p-14">
              <h2
                ...
                style={{ color: CHAMPION_BLUE }}
              >
                {"What Challenges Do Retail and Consumer Businesses Face in Modernizing Their Technology?"}
              </h2>

              <p className="font-body mt-5 text-[17px] leading-relaxed text-slate-600 lg:text-[18px]">
                Retail and consumer businesses balance changing customer
                expectations, connected channels, digital commerce
                complexity, fragmented data, supply chain pressure, and the
                need to move quickly across web, mobile, and physical
                experiences. Starfii addresses these together with
                e-commerce, customer experience, digital commerce,
                personalization, AI, analytics, supply chain, and mobile and
                web capabilities.
              </p>
            </div>
            ...
            <div className="relative min-h-[320px] overflow-hidden">
              <img
                ...
                alt="Retail customer using a digital commerce experience"
                loading="lazy"
                decoding="async"
      ...
      {/* ============================================================
          CAPABILITIES  (271–278. E-commerce through Mobile and web)
      ============================================================ */}
      <section
        id="capabilities"
        ...
        <div className={`relative ${ALIGN}`}>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              {/* <Eyebrow variant="light">{"Retail & Consumer"}</Eyebrow> */}

              <h2
                className={`${SECTION_HEADING} mt-4 max-w-500`}
                style={{ color: CHAMPION_BLUE }}
              >
                {"Our Retail & Consumer Technology Capabilities"}
              </h2>

              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                Starfii covers the full retail technology landscape, from
                e-commerce and customer experience to personalization, data,
                AI, supply chain, and mobile and web, so retailers can
      ...
      <div className={ALIGN}>
        {/* ============================================================
            TABBED DEEP-DIVE  (271–278)
        ============================================================ */}
        <Reveal as="section" className="mt-24 pb-28">
          {/* <Eyebrow>{"Retail & Consumer"}</Eyebrow> */}
          <h2
      ...
      {/* ============================================================
          USE CASES (dark)  (279. Use cases) — click "+" to expand
      ============================================================ */}
