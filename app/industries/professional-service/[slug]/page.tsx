...
export async function generateMetadata({
  ...
  if (!study) {
    return {
      title: "Professional Services Case Study | Starfii",
      description:
        "Starfii professional services technology and digital transformation case study.",
    };
  }
...
export default async function ProfessionalServicesCaseStudyPage({
  params,
}: PageProps) {
  const { slug } = await params;
