//  Insurance -- page  (/industries/insurance)
...
---------------------------------------------------------------- */
const CASE_STUDY_BASE = "/industries/insurencee/casestudies";
const CAPABILITY_BASE = "/industries/insurance/capabilities";

/* ===============================================================
   CONTENT
   Page 19 — Insurance  (/industries/insurance)
   235. Industry challenges  -> Hero + Key Takeaways + Q&A block
   236. Digital insurance    -> Capability card + tab
   237. Claims               -> Capability card + tab
   238. Policy management    -> Capability card + tab
   239. Customer portals     -> Capability card + tab
   240. AI and automation    -> Capability card + tab
   241. Data and analytics   -> Capability card + tab
   242. Application modern.  -> Capability card + tab
   243. Use cases            -> Use Cases accordion (dark)
   244. Case studies         -> Case Studies section
   245. CTA                  -> Closing CTA (GetInTouch)
================================================================ */
...
const faqs: Faq[] = [
  {
    question:
      "How does Starfii help insurers modernize legacy policy and claims systems without disruption?",
    answer:
      "Starfii modernizes legacy insurance applications in stages instead of a single big-bang replacement. We wrap existing systems with APIs, move workloads in priority order, and run old and new components side by side until each step is validated. This keeps policy and claims operations running while the insurer moves to a more maintainable, scalable foundation.",
  },
  {
    question: "What does a digital insurance platform from Starfii include?",
    answer:
      "Our digital insurance platforms cover quote, purchase, servicing, renewals, and policy change journeys across web and mobile. They are built on a modular, API-first architecture, so insurers can add new products, channels, and integrations as demand grows without rebuilding the platform each time.",
  },
  {
    question: "How can claims processing be automated without losing control?",
    answer:
      "Starfii digitizes first notice of loss, document collection, triage, workflow routing, and status communication. Automation handles repetitive steps while adjusters keep visibility and final decision authority, with audit trails that show how every claim moved from submission to resolution.",
  },
  {
    question:
      "How can AI be used safely in a regulated insurance environment?",
    answer:
      "Starfii applies AI to document processing, claims triage, customer service, fraud signals, and underwriting support. Every solution is built with governance, explainability, security, and human oversight, so decisions can be reviewed, audited, and defended to regulators and customers alike.",
  },
  {
    question: "How does Starfii improve customer portals for policyholders?",
    answer:
      "We build secure portals where customers can view policies, update information, submit documents, track claims, make payments, and communicate with their insurer. Responsive design and clear information architecture reduce friction and lower the volume of routine service requests.",
  },
  {
    question: "How do data and analytics help insurers make better decisions?",
    answer:
      "We consolidate data from policy, claims, customer, and channel systems into governed platforms. On top of that, we build reporting pipelines, dashboards, and analytics that give teams a trusted view of performance, risk, customer behavior, and business trends.",
  },
  {
    question:
      "How does Starfii keep insurance applications secure and audit ready?",
    answer:
      "Security and compliance are built into design, code, infrastructure, and operations. This includes identity and access management, encryption, secure APIs, monitoring, and the evidence auditors ask for, so customers and the insurer stay protected as digital channels expand.",
  },
  {
    question:
      "How can we get started with Starfii on an insurance technology initiative?",
    answer:
...
const keyTakeaways = [
  {
    title: "Modernize",
    body: "Starfii helps insurers modernize digital journeys, policy and claims platforms, and legacy applications with secure, scalable technology built for regulated environments.",
  },
  {
    title: "Simplify",
    body: "We engineer digital insurance, claims, and customer portal experiences, backed by data and analytics, so every step from quote to renewal to claim feels clear, fast, and easy to manage.",
  },
  {
    title: "Protect",
    body: "Our capabilities span AI and automation, data foundations, and application modernization with governance built in, so insurers reduce operational effort and risk while keeping pace with customer expectations.",
  },
];

/* --- 236–242. The seven insurance capabilities ------------------ */
type Capability = { slug: string; title: string; body: string };

const capabilities: Capability[] = [
  {
    slug: "digital-insurance",
    title: "Digital Insurance",
    body: "Starfii modernizes quote, purchase, servicing, and renewal journeys, making insurance simpler to understand and easier to manage while keeping regulatory controls in place.",
  },
  {
    slug: "claims",
    title: "Claims",
    body: "We digitize claims intake, documents, workflow, assessment, and communication, so adjusters decide consistently and customers stay informed from submission to resolution.",
  },
  {
    slug: "policy-management",
    title: "Policy Management",
    body: "Starfii modernizes quoting, issuance, endorsements, renewals, and servicing workflows on an API-first architecture that connects policy capabilities with digital channels.",
  },
  {
    slug: "customer-portals",
    title: "Customer Portals",
    body: "We build secure portals where customers view policies, submit documents, track claims, and make payments, reducing friction across the entire customer lifecycle.",
  },
  {
    slug: "ai-and-automation",
    title: "AI and Automation",
    body: "Starfii applies AI and intelligent automation to document processing, claims triage, fraud signals, and service workflows, with governance and human oversight built in.",
  },
  {
    slug: "data-and-analytics",
    title: "Data and Analytics",
    body: "We create governed data foundations and analytics that connect policies, claims, customers, and operations, giving insurers a clearer view of risk and performance.",
  },
  {
    slug: "application-modernization",
    title: "Application Modernization",
    body: "Starfii modernizes legacy insurance applications incrementally through APIs, modular services, and cloud-ready architecture, without disrupting critical operations.",
  },
];
...
const tabs: ServiceTab[] = [
  {
    ...
    heading: "Digital insurance experiences built for modern customers",
    body: "Starfii helps insurers modernize digital journeys across quote, purchase, servicing, renewals, and policy changes. We combine experience design, engineering, integrations, and automation to make insurance simpler to understand and easier to manage while maintaining security and regulatory controls.",
    image:
  ...
  },
  {
    id: "claims",
    label: "Claims",
    heading: "Claims experiences that move from submission to resolution faster",
    body: "We digitize claims intake, document collection, workflow orchestration, assessment, communication, and status tracking. Intelligent automation can reduce repetitive work while giving adjusters the information they need to make consistent decisions and keep customers informed.",
    image:
  ...
  },
  {
    ...
    heading: "Policy management platforms designed for agility and control",
    body: "Starfii modernizes policy administration workflows across quoting, underwriting support, issuance, endorsements, renewals, billing integrations, and servicing. API-first architecture helps insurers connect policy capabilities with digital channels and surrounding enterprise systems.",
    image:
  ...
  },
  {
    ...
    heading: "Customer portals that make insurance easier to manage",
    body: "We build secure portals where customers can view policies, update information, submit documents, track claims, make payments, and communicate with their insurer. Responsive experiences and clear information architecture help reduce friction across the customer lifecycle.",
    image:
  ...
  },
  {
    ...
    heading: "AI and automation for smarter insurance operations",
    body: "Starfii applies AI and intelligent automation to document processing, claims triage, customer service, fraud signals, underwriting support, and repetitive operational workflows. Solutions are designed with governance, explainability, security, and human oversight in mind.",
    image:
  ...
  },
  {
    ...
    heading: "Data and analytics that give insurers a clearer view",
    body: "We create governed data foundations, reporting pipelines, dashboards, and analytics capabilities that connect information across policies, claims, customers, channels, and operations. Insurers gain stronger visibility into performance, risk, customer behavior, and business trends.",
    image:
  ...
  },
  {
    ...
    heading: "Application modernization without disrupting insurance operations",
    body: "Starfii modernizes legacy insurance applications incrementally through APIs, modular services, cloud-ready architecture, automated testing, and integration patterns. The goal is to improve maintainability, resilience, and delivery speed while keeping critical insurance operations running.",
    image:
...
const useCases: UseCase[] = [
  {
    title: "Digital Quote and Purchase",
    body: "Create simpler quote and purchase journeys with digital forms, integrations, workflow orchestration, identity, payments, and personalized customer experiences.",
  },
  {
    title: "Claims Automation",
    body: "Digitize first notice of loss, document intake, triage, communication, and workflow routing to reduce manual effort and improve claims visibility.",
  },
  {
    title: "Policy Servicing",
    body: "Give customers and service teams easier ways to manage policy changes, renewals, documents, billing information, and service requests.",
  },
  {
    title: "Underwriting Support",
    body: "Bring together structured and unstructured information to support underwriting workflows, risk review, document processing, and decision support.",
  },
  {
    title: "Fraud Detection",
    body: "Use data, rules, and AI-assisted analysis to identify suspicious patterns and help investigators prioritize cases for review.",
  },
  {
    title: "Customer Service Automation",
    body: "Automate routine insurance questions and requests while routing complex cases to the right service team with the necessary customer context.",
  },
];

/* ===============================================================
   CASE STUDIES
   NOTE: slugs below must match real entries in data/case-studies.tsx.
   Replace them with your actual insurance case study slugs.
================================================================ */
...
const caseStudies: CaseStudy[] = [
  {
    ...
    body: "A digital modernization program improved customer journeys and application foundations while creating a more scalable experience layer.",
  },
  {
    ...
    body: "Engineering and automation capabilities helped streamline document-heavy workflows while keeping controls and auditability visible.",
  },
  {
    ...
    body: "A phased application modernization approach moved critical workloads toward a more maintainable and scalable architecture.",
  },
  {
              ...
              <Reveal key={item.title} delay={index * 80}>
                ...
                >
                  <button
                    ...
                    aria-controls={`ins-usecase-panel-${index}`}
          ...
          <Reveal key={faq.question} delay={(i % 5) * 70}>
            ...
            >
              ...
              <div
                id={`ins-faq-panel-${i}`}
                role="region"
                aria-labelledby={`ins-faq-button-${i}`}
                className="ss-eco-panel grid transition-all duration-500 ease-out"
                style={{ gridTemplateRows: isOpen ? "1fr" : "0fr" }}
              >
                <div className="overflow-hidden">
...
export default function InsuranceSection(): ReactElement {
  ...
  // Deep links such as ...#claims open that tab
  useEffect(() => {
  ...
  return (
    <main className="bg-white">
      ...
      {/* ============================================================
          HERO  (235. Industry challenges)
      ============================================================ */}
      <section className="relative isolate min-h-[460px] overflow-hidden lg:min-h-[620px]">
        <div className="absolute inset-0 -z-10">
          <img
            src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=85&w=2000&auto=format&fit=crop"
            alt="Insurance documents and financial planning"
            loading="eager"
            decoding="async"
            fetchPriority="high"
        ...
        <div className={`${ALIGN} relative flex min-h-[460px] items-center lg:min-h-[620px]`}>
          <div className="w-full max-w-[760px] py-10 lg:py-12">
            ...
            >
              Insurance Technology Solutions for Modern Insurers
            </h1>
            ...
            >
              Modernize insurance products, customer experiences and
      ...
      <div className={ALIGN}>
        ...
        <Reveal as="section" className="mt-16">
          ...
          <p
            ...
            style={{ color: CHAMPION_BLUE }}
          >
            Starfii helps insurers modernize digital journeys, claims, policy
            platforms, and applications with secure, data driven technology,
        ...
        {/* ============================================================
            Q&A BLOCK  (235. Industry challenges)
        ============================================================ */}
          ...
          <div className="group grid grid-cols-1 items-stretch overflow-hidden rounded-lg bg-[#F5F3FC] transition-colors duration-500 ease-out hover:bg-[#EAE4FA] lg:grid-cols-2">
            <div className="flex flex-col justify-center p-10 transition-transform duration-500 ease-out group-hover:translate-x-2 lg:p-14">
              <h2
                ...
                style={{ color: CHAMPION_BLUE }}
              >
                {"What Challenges Do Insurers Face in Modernizing Their Technology?"}
              </h2>

              <p className="font-body mt-5 text-[17px] leading-relaxed text-slate-600 lg:text-[18px]">
                Insurers balance changing customer expectations, complex
                policy and claims operations, legacy applications,
                fragmented data, fraud risk, and demanding regulatory
                requirements. Starfii addresses these together with digital
                insurance, claims, policy management, customer portals, AI
                and automation, data and analytics, and application
                modernization.
              </p>
            </div>
            ...
            <div className="relative min-h-[320px] overflow-hidden">
              <img
                ...
                alt="Insurance professionals collaborating on business technology"
                loading="lazy"
                decoding="async"
      ...
      {/* ============================================================
          CAPABILITIES  (236–242. Digital insurance through Application modernization)
      ============================================================ */}
      <section
        id="capabilities"
        ...
        <div className={`relative ${ALIGN}`}>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              {/* <Eyebrow variant="light">Insurance</Eyebrow> */}
              ...
              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                Starfii covers the full insurance technology landscape, from
                digital insurance and claims to AI, analytics, and
                application modernization, so insurers can evolve with
                confidence.
              </p>
            </Reveal>
      ...
      {/* ============================================================
          USE CASES (dark)  (243. Use cases) — click "+" to expand
      ============================================================ */}
