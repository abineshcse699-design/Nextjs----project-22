...
export async function generateMetadata({
  ...
  if (!study) {
    return {
      title: "Insurance Case Study | Starfii",
      description: "Starfii insurance technology and digital transformation case study.",
    };
  }
...
export default async function InsuranceCaseStudyPage({
  params,
}: PageProps) {
  const { slug } = await params;
