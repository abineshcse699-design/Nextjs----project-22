...
const TPP_URL = "/industries/technology-products";
const CASE_STUDY_BASE = TPP_URL;
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={TPP_URL} className="hover:text-[#3a3ff0]">
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Schedule some 1 on 1 time with our technology and product experts.
        </p>
        <Link
          href={`${TPP_URL}#connect`}
      ...
      <section className="bg-[#0b1747] py-20">
        <div className="mx-auto max-w-[1000px] px-6 text-center sm:px-10">
          <h2 className="font-heading mt-2 text-[34px] font-medium leading-tight tracking-[-0.02em] text-white sm:text-[42px]">
            Building the future of technology products and platforms
          </h2>
          <p className="font-body mx-auto mt-5 max-w-2xl text-[17px] leading-8 text-slate-300">
            Explore how Starfii helps technology companies engineer scalable
            products, modernize platforms, and ship faster with confidence.
          </p>
          <Link
            href={TPP_URL}
