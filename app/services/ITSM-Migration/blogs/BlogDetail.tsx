...
// NOTE: this file lives at app/services/itsm-migration/blogs/BlogDetail.tsx
// so the base paths below are relative to that service, not
// global-capability-centers. Keep these in sync with the folder
// this file actually lives in if it is ever moved.
const BLOG_BASE =
  "/services/ITSM-Migration/blogs";

const SERVICE_BASE =
  "/services/ITSM-Migration";
                  ...
                  <section className="mt-20 overflow-hidden rounded-[32px] bg-[#0A0912] p-7 sm:p-10 lg:p-12">
                    ...
                    <div className="max-w-2xl">
                      ...
                      <p className="mt-5 text-base leading-8 text-white/60">
                        A well planned ITSM migration protects service continuity while modernizing data, workflows, and integrations for how the business actually operates.
                      </p>
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-[28px] bg-[#F5F3FC] p-6">
                  ...
                  >
                    Migrate to a modern ITSM platform with confidence
                  </h2>

                  <p className="mt-4 text-sm leading-7 text-slate-600">
                    Move data, configurations, workflows, and integrations to a modern service management environment with a structured, low risk approach.
                  </p>
          ...
          <div className={ALIGN}>
            ...
            <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
              ...
              <div>
                ...
                >
                  Explore more ITSM migration insights
                </h2>
