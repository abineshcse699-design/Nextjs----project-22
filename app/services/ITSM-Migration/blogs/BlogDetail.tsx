// app/services/itsm-migration/blogs/BlogDetail.tsx
...
// Keep these in sync with the real folder names on disk.
// (Linux/Vercel is case-sensitive: "ITSM-Migration" != "itsm-migration".)
        ...
        <div className={`relative ${ALIGN}`}>
          <div className="grid grid-cols-1 gap-12 pt-14 lg:grid-cols-[minmax(0,1fr)_350px] lg:gap-16">
            ...
            <article className="min-w-0">
              ...
              {/* Body */}
              <div className="mt-16">
                <h2 className={SECTION_HEADING}>ITSM Migration in Practice</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl bg-[#F5F3FC] p-6">
                  ...
                  <p className={`${CARD_BODY} mt-4`}>
                    Move data, configurations, workflows, and integrations to a
                    modern service management environment with a structured, low
                    risk approach.
                  </p>
        ...
        <section className="mt-24 bg-[#EEF0F5] py-24">
          <div className={ALIGN}>
            <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
              <h2 className={SECTION_HEADING}>Explore more ITSM migration insights</h2>
