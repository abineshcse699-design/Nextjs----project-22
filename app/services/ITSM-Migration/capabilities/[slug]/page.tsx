// app/services/ITSM-Migration/capabilities/[slug]/page.tsx
//
// Built section by section from the Cloud Engineering capability detail
// page (hero -> overview -> capability cards -> dark section -> gradient
// carousel -> FAQ -> closing CTA), with the same tokens, type scale,
// spacing, animations and hover effects. Identical in structure to
// app/services/cloud/capabilities/[slug]/page.tsx and
...
/* ===============================================================
   BRAND TOKENS — identical to the Cloud Engineering page
================================================================ */
...
/* ===============================================================
   ...
   app/services/ITSM-Migration/capabilities/[slug]/page.tsx
   (case-sensitive in production — keep "ITSM-Migration" exact)
================================================================ */

const SERVICES_BASE = "/services";
const SERVICE_BASE = "/services/ITSM-Migration";
const CAPABILITY_BASE = "/services/ITSM-Migration/capabilities";
...
const processSteps = [
  {
    icon: Search,
    title: "Assess",
    body: "We audit your current ITSM platform, workflows, and data quality to understand exactly what needs to move before any migration plan is proposed.",
  },
  {
    icon: PenTool,
    title: "Design",
    body: "Target state processes, roles, and platform configuration are planned and validated with your team before a single record moves.",
  },
  {
    icon: Code2,
    title: "Migrate & Validate",
    body: "Data, configuration, workflows, and integrations are migrated in sequenced waves, with every step tested against real scenarios.",
  },
  {
    icon: Rocket,
    title: "Cutover & Support",
    body: "We manage go live with runbooks and rollback plans, then stay on through post migration support as usage and needs evolve.",
  },
];

/* ===============================================================
   GLOBAL KEYFRAMES — same CSS as the Cloud Engineering page
================================================================ */
...
export default async function CapabilityDetailPage({
  ...
  // Everything else in the "ITSM Migration & Transformation" grid.
  ...
  return (
    <main className="bg-white">
      ...
      {/* ============================================================
          HERO — identical to the Cloud Engineering hero
      ============================================================ */}
      ...
      <div className={ALIGN}>
        {/* ============================================================
            OVERVIEW — same block as the Cloud page's "Q&A" section
        ============================================================ */}
      ...
      {/* ============================================================
          KEY FEATURES — same as the Cloud page's capability cards
      ============================================================ */}
      <section
        id="features"
          ...
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              ...
              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                A closer look at what Starfii builds and operates under{" "}
                {capability.title.toLowerCase()}, so your team migrates with
                confidence.
              </p>
            </Reveal>
      ...
      {/* ============================================================
          HOW WE DELIVER — same dark section as Cloud "How We Deliver"
      ============================================================ */}
      ...
      {/* ============================================================
          OTHER CAPABILITIES — same as the Cloud "Other Capabilities"
      ============================================================ */}
      <OtherCapabilities
      ...
      {/* ============================================================
          FAQ — same section as the Cloud page FAQ
      ============================================================ */}
      <section
        id="faq"
