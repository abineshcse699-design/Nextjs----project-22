...
// app/services/ITSM-Migration/capabilities/othercapabilities.tsx
// Same section, cards and carousel as the Cloud Engineering and
// Data & Analytics "Other Capabilities" blocks.
      ...
      <div className={ALIGN}>
        <Reveal className="flex items-center justify-between gap-6">
          <div>
            ...
            >
              Other ITSM Migration Capabilities
            </h2>
          </div>
