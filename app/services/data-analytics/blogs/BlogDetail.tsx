// app/services/data-analytics/blogs/BlogDetail.tsx
      ...
      <section className="bg-gradient-to-b from-[#cfe3f2] via-[#e1ecf6] to-[#eef0f5] pb-10 pt-28 sm:pt-32">
        <div className={ALIGN}>
          ...
          >
            ...
            <Link href="/services/data-analytics" className="hover:text-[#4F3FE0]">
              Data &amp; Analytics
            </Link>
            <ChevronRight size={14} />
        ...
        <div className={`relative ${ALIGN}`}>
          <div className="grid grid-cols-1 gap-12 pt-14 lg:grid-cols-[minmax(0,1fr)_350px] lg:gap-16">
            ...
            <article className="min-w-0">
              ...
              {/* Body */}
              <div className="mt-16">
                <h2 className={SECTION_HEADING}>Data &amp; Analytics in Practice</h2>
