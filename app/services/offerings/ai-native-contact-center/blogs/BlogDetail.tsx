            ...
            <article className="min-w-0">
              ...
              <div className="mt-16">
                <div className="mb-8">
                  ...
                  >
                    Building Smarter Voice Experiences
                  </h2>
                </div>
                ...
                <section className="mt-20 overflow-hidden rounded-[32px] bg-[#0A0912] p-7 sm:p-10 lg:p-12">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-5 text-base leading-8 text-white/60">
                      The strongest voice AI programs connect conversational design to
                      measurable customer, agent, and business outcomes.
                    </p>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-[28px] bg-[#F5F3FC] p-6">
                  ...
                  <p className="mt-4 text-sm leading-7 text-slate-600">
                    Starfii helps enterprises build AI powered voice experiences that
                    connect customer conversations, intelligent automation, routing,
