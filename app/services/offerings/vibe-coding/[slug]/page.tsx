          ...
          <article className="max-w-4xl">
            ...
            <section id="client">
              ...
              <p className="mt-5 text-[16px] leading-[1.9] text-slate-600">
                Starfii helps organizations capture
                meeting conversations, understand
                business context, generate structured
                summaries, identify decisions and
                action items, and connect meeting
                outcomes with the workflows that
                move work forward.
              </p>
            ...
            >
              ...
              <p className="mt-6 text-[16px] leading-[1.9] text-slate-600">
                Important decisions, customer
                requirements, action items, risks,
                and commitments are often buried
                inside long business conversations.
                Manually capturing and organizing
                this information can be inconsistent
                and time consuming.
              </p>

              <p className="mt-5 text-[16px] leading-[1.9] text-slate-600">
                The opportunity was to automatically
                capture conversations, understand
                what was discussed, and transform
                meetings into structured intelligence
                that teams could actually use after
            ...
            >
              ...
              <p className="mt-6 text-[16px] leading-[1.9] text-slate-600">
                Starfii combines speech intelligence,
                AI-powered summarization, natural
                language understanding, and workflow
                automation to transform meeting
                conversations into structured business
                information.
              </p>

              <p className="mt-5 text-[16px] leading-[1.9] text-slate-600">
                Meeting intelligence can capture
                discussions, identify important topics
                and decisions, surface action items,
                and connect outcomes with CRM, project
            ...
            >
              ...
              <p className="mt-6 text-[16px] leading-[1.9] text-slate-600">
                AI meeting intelligence helps teams
                spend less time documenting
                conversations and more time acting
                on the information, decisions, and
                commitments that emerge from meetings.
              </p>
            ...
            >
              ...
              >
                Business benefits of AI meeting intelligence
              </h2>

              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">

                {[
                  "Reduce manual meeting documentation",
                  "Improve action-item follow-through",
                  "Make decisions easier to discover",
                  "Preserve institutional knowledge",
                  "Improve customer conversation visibility",
                  "Accelerate post-meeting workflows",
                ].map((item) => (
                  <div
                    key={item}
                    className="rounded-2xl p-6"
            ...
            >
              ...
              >
                AI technologies powering intelligent meetings
              </h2>
          ...
          >
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-2xl text-[16px] leading-[1.8] text-white/75">
                Build an AI meeting experience that
                captures conversations, summarizes
                what matters, identifies actions and
                decisions, and connects meeting
                outcomes with your business workflows.
              </p>
