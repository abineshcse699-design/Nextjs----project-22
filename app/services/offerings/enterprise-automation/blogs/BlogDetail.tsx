              ...
              <div className="mt-16">
                <div className="mb-8">
                  ...
                  <h2
                    ...
                    style={{ color: CHAMPION_BLUE }}
                  >
                    AI-Powered Medical Coding in Practice
                  </h2>
                </div>
                  ...
                  <section className="mt-20 overflow-hidden rounded-[32px] bg-[#0A0912] p-7 sm:p-10 lg:p-12">
                    <div className="max-w-2xl">
                      ...
                      <h2 className="mt-3 text-3xl font-semibold text-white sm:text-4xl">
                        Why AI-Powered Medical Coding matters
                      </h2>

                      <p className="mt-5 text-base leading-8 text-white/60">
                        The strongest coding automation programs connect
                        workflow improvements to measurable accuracy,
                        compliance, and revenue cycle outcomes.
                      </p>
                    </div>
                  ...
                  <section className="mt-20">
                    <div className="max-w-2xl">
                      ...
                      <h2
                        ...
                        style={{ color: CHAMPION_BLUE }}
                      >
                        A practical coding automation journey
                      </h2>
                    </div>
