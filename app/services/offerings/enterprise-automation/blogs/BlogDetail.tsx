...
import type { BlogPost, BlogSection } from "../blogs/blogsData";
...
const BLOG_BASE =
  "/services/offerings/enterprise-automation/blogs";
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="mt-8 rounded-3xl bg-[#F5F3FC] p-6">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600">
                Starfii helps healthcare organizations modernize medical
                coding with AI-assisted clinical documentation analysis,
                coding intelligence, validation, and workflow automation.
              </p>

              <Link
                href="/services/offerings/enterprise-automation#connect"
