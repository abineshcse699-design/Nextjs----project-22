...
const keyTakeaways: string[] = [
  "Starfii's AI-powered medical coding solutions transform clinical documentation into structured coding intelligence that supports faster, more consistent, and reviewable coding workflows.",
  "We combine clinical language understanding, AI-assisted code recommendations, validation rules, and human review to reduce repetitive coding effort without removing professional oversight.",
  "The solution can support ICD, CPT, HCPCS, and related coding workflows depending on specialty, geography, payer requirements, and organizational policy.",
...
const tabs: ServiceTab[] = [
  {
    label: "Capture Clinical Documentation",
...
const industryAwards: IndustryAward[] = [
  {
    year: "Healthcare AI",
    category: "Clinical Documentation Intelligence",
    subcategory: "AI-Assisted Coding Workflows",
    rank: "Enterprise Ready",
    description:
      "AI-assisted healthcare workflows designed to analyze clinical documentation, surface coding-relevant information, and support qualified professionals with structured coding recommendations.",
  },
  {
    year: "Healthcare AI",
    category: "Coding Quality Intelligence",
    subcategory: "Validation, Review & Governance",
    rank: "Enterprise Ready",
    description:
      "Workflow capabilities that combine automated checks with human review to improve coding consistency, exception handling, traceability, and operational governance.",
  },
  {
    year: "Healthcare AI",
    category: "Revenue Cycle Enablement",
    subcategory: "Coding & Claims Workflow Support",
    rank: "Enterprise Ready",
    description:
      "Integrated coding intelligence that helps healthcare organizations reduce repetitive work and connect validated coding outcomes with broader revenue cycle operations.",
  },
];
...
export default function MedicalCodingSection(): ReactElement {
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className={`${ALIGN} py-24 lg:py-32`}>
          ...
          >
            ...
            <ChevronRight size={14} />
            <span className="text-slate-500">AI-Powered Medical Coding</span>
          </nav>
          ...
          >
            AI-Powered Medical Coding for Modern Healthcare
          </h1>
          ...
          >
            Starfii helps healthcare organizations modernize medical coding with AI-assisted clinical documentation analysis, coding intelligence, validation, and workflow automation.
          </p>
          ...
          >
            Explore AI Medical Coding Solutions
      ...
      <div className={ALIGN}>
        ...
        <Reveal as="section" className="mt-16">
            ...
            >
              <div className="pt-7">
                ...
                <p className="font-body mt-3 text-[14px] leading-relaxed text-slate-600">
                  Analyze clinical documentation and surface diagnoses,
                  procedures, conditions, and coding-relevant context.
                </p>
              </div>
              ...
              <div className="pt-7">
                ...
                <p className="font-body mt-3 text-[14px] leading-relaxed text-slate-600">
                  Generate structured coding recommendations and supporting
                  evidence to accelerate first-pass coding work.
                </p>
              </div>
              ...
              <div className="pt-7">
                ...
                <p className="font-body mt-3 text-[14px] leading-relaxed text-slate-600">
                  Combine AI validation with qualified human review so
                  important coding decisions remain controlled and traceable.
                </p>
              </div>
            </div>
          </div>
          ...
          <p
            ...
            style={{ color: CHAMPION_BLUE }}
          >
            Transform clinical documentation into accurate, reviewable
            coding intelligence that helps healthcare teams work faster,
            more consistently, and with greater operational confidence.
          </p>
        </Reveal>
        ...
        <Reveal as="section" className="mt-20">
          ...
          >
            <div>
              ...
              >
                How Can AI Transform Medical Coding Operations?
              </h2>
              <p className="font-body mt-5 text-[15px] leading-relaxed text-slate-600">
                Healthcare organizations can modernize medical coding by combining AI-assisted clinical documentation analysis, coding recommendations, automated validation, and human review. Starfii brings these capabilities together to reduce repetitive work, improve consistency, accelerate turnaround, and connect coding intelligence with broader revenue cycle operations.
              </p>
            </div>
        ...
        <div className={`relative ${ALIGN}`}>
          <Reveal className="max-w-xl">
            <h2 className="font-heading text-[36px] font-medium leading-[1.15] text-white lg:text-[44px]">
              Our Medical Coding &amp; Healthcare AI Capabilities
            </h2>
            <p className="font-body mt-5 text-[15px] leading-relaxed text-white/60">
              Starfii applies healthcare AI to clinical documentation, coding workflows, validation, and revenue cycle operations, helping organizations improve productivity while keeping professional review and governance at the center.
            </p>
          </Reveal>
