...
const insights: InsightPost[] = [
  ...
  },
  {
    ...
    title: "AI Document Management: Turning Files Into Actionable Knowledge",
    body: "Explore how document intelligence, automated classification, and metadata enrichment can help teams turn unstructured files into useful business information.",
  },
  {
    large: false,
    image:
      "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=800&auto=format&fit=crop",
    title: "Enterprise Content Search: Finding Information Faster With AI",
    body: "See how semantic search and natural-language discovery can help employees find relevant documents and business knowledge without relying on complex folder structures.",
  },
];
/* ===============================================================
   GLOBAL KEYFRAMES
...
>
  <div className={ALIGN}>
    <Reveal className="flex items-center justify-between">
      ...
      >
        Sustainability Services Use Cases
      </h2>

      <Link
        href={"/services/offerings/sustainability-services"}
    ...
    <div className="mt-12">
      <PagedCarousel
        ...
        renderItem={(study, i) => (
          ...
          >
          <Link
  href={`/services/offerings/sustainability-services/${study.slug}`}
