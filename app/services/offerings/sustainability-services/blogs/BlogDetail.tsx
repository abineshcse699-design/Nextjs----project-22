                  ...
                  <section className="mt-20 overflow-hidden rounded-[32px] bg-[#0A0912] p-7 sm:p-10 lg:p-12">
                    ...
                    <div className="max-w-2xl">
                      ...
                      <p className="mt-5 text-base leading-8 text-white/60">
                        The strongest sustainability programs connect
                        technology and process improvements to measurable
                  ...
                  <section className="mt-20">
                    ...
                    <div className="max-w-2xl">
                      ...
                      <p className="mt-4 text-base leading-7 text-slate-600">
                        ...
                        current workflow, introduce
                        automation, validate outcomes,
                    ...
                    <div className="relative mt-10">
                      ...
                      <div
                        className="absolute left-5 top-5 hidden h-[calc(100%-40px)] w-px sm:block"
                        style={{
                          backgroundColor:
                            "#DDD8F3",
                        }}
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-[28px] bg-[#F5F3FC] p-6">
                  ...
                  >
                    Need smarter enterprise workflows?
                  </h2>

                  <p className="mt-4 text-sm leading-7 text-slate-600">
                    Explore intelligent automation,
                    workflow optimization, AI-assisted
