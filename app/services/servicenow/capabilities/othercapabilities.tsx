...
// app/services/servicenow/capabilities/othercapabilities.tsx
// "Other ServiceNow ITSM Capabilities" gradient section with a
      ...
      <div className={ALIGN}>
        <Reveal className="flex items-center justify-between gap-6">
          <div>
            ...
            >
              Other ServiceNow ITSM Capabilities
            </h2>
          </div>
