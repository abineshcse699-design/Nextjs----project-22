...
// Keep these base paths in sync with the folder this file actually
// lives in if it is ever moved.
const BLOG_BASE =
  "/services/itsm-service-management/blogs";

const SERVICE_BASE =
  "/services/itsm-service-management";
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-5 flex items-center gap-4">
                    ...
                    <span
                      className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-2xl text-lg font-semibold text-white"
                      style={{
          ...
          <div className={ALIGN}>
            ...
            <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
              ...
              <div>
                ...
                >
                  Explore more ITSM &amp; service management insights
                </h2>
