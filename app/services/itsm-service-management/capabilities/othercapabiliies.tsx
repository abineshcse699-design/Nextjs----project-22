...
// app/services/itsm-service-management/capabilities/othercapabilities.tsx
// Same section, cards and carousel as the Software & Product Engineering,
// Data & Analytics, and Cloud Engineering "Other Capabilities" blocks.
...
import Reveal from "../capabilities/reveal";
      ...
      <div className={ALIGN}>
        <Reveal className="flex items-center justify-between gap-6">
          <div>
            ...
            >
              Other ITSM & Enterprise Service Management Capabilities
            </h2>
          </div>
