// app/services/itsm-service-management/capabilities/[slug]/page.tsx
//
...
// tokens, type scale, spacing, animations and hover effects. Identical
// in structure to app/services/cloud/capabilities/[slug]/page.tsx.
...
import OtherCapabilities from "../othercapabiliies";
...
const CAPABILITY_BASE = "/services/itsm-service-management/capabilities";
...
const processSteps = [
  {
    icon: ClipboardList,
    title: "Assess",
    body: "We review your current service processes, platform configuration, and support data to understand where the operating model stands before anything changes.",
  },
  {
    icon: Workflow,
    title: "Design",
    body: "Workflows, approvals, catalogs, and governance rules are planned and validated with your team before any configuration is built.",
  },
  {
    icon: ShieldCheck,
    title: "Configure & Automate",
    body: "Our team configures the platform and automates repetitive steps in short, visible increments, so you see progress early, not just at the end.",
  },
  {
    icon: LifeBuoy,
    title: "Operate & Optimize",
    body: "We support the environment after go live, monitoring adoption, SLA performance, and process health as teams and request volume grow.",
  },
];
...
export default async function CapabilityDetailPage({
  ...
  // Everything else in the "ITSM & Enterprise Service Management" grid.
          ...
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              ...
              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                ...
                {capability.title.toLowerCase()}, so your team can scale
