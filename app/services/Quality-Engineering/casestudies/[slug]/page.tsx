...
const QUALITY_ENGINEERING_URL = "/services/quality-engineering";

/* ---------- static Quality Engineering copy (kept from the previous page) ---------- */

const STRATEGY_NOTE =
  "The testing strategy was designed to move quality checks earlier into the software delivery lifecycle.";

const QUALITY_GROUPS = [
  {
    title: "Testing & Validation",
    points: [
      "Validate functional behavior, integrations, APIs, performance, and critical user journeys before production.",
    ],
  },
  {
    title: "Risk Control",
    points: [
      "Prioritize high risk scenarios and continuously validate the areas that matter most to the business.",
    ],
  },
  {
    title: "Continuous Quality",
    points: [
      "Move quality checks into CI/CD so every meaningful change can be validated before release.",
    ],
  },
];
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={QUALITY_ENGINEERING_URL} className="hover:text-[#3a3ff0]">
        Quality Engineering
      </Link>
      <ChevronRight className="h-3.5 w-3.5" />
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          Build a quality engineering strategy that improves reliability,
          accelerates releases, and scales with your enterprise.
        </p>
        <Link
          href="/contact"
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_360px]">
          <div className="min-w-0">
            ...
            <div className="mt-10">
              ...
              {/* Solution (approach, solution, execution phases, capabilities) */}
              <section id="solution" className="mt-20 scroll-mt-28">
                ...
                <Paragraphs items={[study.solution, STRATEGY_NOTE]} />
              ...
              <section id="benefits" className="mt-20 scroll-mt-28">
                ...
                <GroupList groups={QUALITY_GROUPS} />
              </section>
