...
const BLOG_BASE = "/services/global-capability-centers/blogs";
const SERVICE_BASE = "/services/global-capability-centers";
            ...
            <article className="min-w-0">
              ...
              <div className="mt-7 flex flex-wrap items-center justify-between gap-5 border-b border-slate-200 pb-7">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {/* <Linkedin size={17} style={{ color: CHAMPION_BLUE }} /> */}
                  </button>
                  ...
                  <button
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white transition-all hover:-translate-y-1 hover:border-[#1B2560] hover:shadow-md"
                  >
                    {/* <Facebook size={17} style={{ color: CHAMPION_BLUE }} /> */}
                  </button>
              ...
              <div className="mt-16">
                <div className="mb-8">
                  ...
                  >
                    Building a Stronger Global Capability Center
                  </h2>
                </div>
                ...
                <section className="mt-20 overflow-hidden rounded-[32px] bg-[#0A0912] p-7 sm:p-10 lg:p-12">
                  <div className="max-w-2xl">
                    ...
                    <p className="mt-5 text-base leading-8 text-white/60">
                      The strongest capability center programs connect operating model
                      decisions to measurable delivery, talent, and business outcomes.
                    </p>
                  </div>
                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="mt-2 text-sm leading-7 text-white/55">{benefit.body}</p>
                          </div>
                        </div>
                      </div>
                    ))}
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start">
              <div className="space-y-6">
                ...
                <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-5 flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs leading-5 text-slate-500">{post.author.role}</p>
                    </div>
                  </div>
                ...
                <div className="rounded-[28px] bg-[#F5F3FC] p-6">
                  ...
                  <h2 className="mt-3 text-xl font-bold leading-tight" style={{ color: CHAMPION_BLUE }}>
                    Need help setting up your GCC?
                  </h2>

                  <p className="mt-4 text-sm leading-7 text-slate-600">
                    Starfii brings entity setup, talent acquisition, governance,
                    compliance, facilities, and transition support together in one
                    connected GCC engagement.
                  </p>
