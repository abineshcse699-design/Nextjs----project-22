                      ...
                      <div className="mt-5 space-y-5">
                        {section.paragraphs.map(
                          (
                            ...
                            /*
                              If paragraph contains a short label
                              before ":" make it bold.
                            */
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="mt-8 rounded-3xl bg-[#F5F3FC] p-6">
              ...
              <p className="mt-4 text-sm leading-7 text-slate-600">
                Starfii brings entity setup, talent
                acquisition, governance, compliance,
                facilities, and transition support
                together in one connected GCC engagement.
              </p>

              <Link
                href="/services/global-capability-centers#connect"
