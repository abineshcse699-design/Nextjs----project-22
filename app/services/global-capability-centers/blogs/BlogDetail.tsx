...
const BLOG_BASE =
  "/services/global-capability-centers/blogs";
            ...
            <article className="min-w-0">
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  >
                    Global Capability Centers in Practice
                  </h2>
                  ...
                  <section className="mt-20 overflow-hidden rounded-[32px] bg-[#0A0912] p-7 sm:p-10 lg:p-12">
                    ...
                    <div className="max-w-2xl">
                      ...
                      <p className="mt-5 text-base leading-8 text-white/60">
                        A well-designed Global Capability Center creates a scalable operating model that connects talent, technology, governance, and business outcomes.
                      </p>
            ...
            <aside className="lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-[28px] bg-[#F5F3FC] p-6">
                  ...
                  >
                    Build and scale your GCC with confidence
                  </h2>

                  <p className="mt-4 text-sm leading-7 text-slate-600">
                    Build a scalable GCC operating model with the right talent, governance, compliance, facilities, and transition support.
                  </p>
