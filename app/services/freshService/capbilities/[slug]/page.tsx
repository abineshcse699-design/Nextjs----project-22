// app/services/freshService/capbilities/[slug]/page.tsx
//
// Built section by section from the Software & Product Engineering /
// Data & Analytics capability detail page (hero -> overview -> capability
// cards -> dark section -> gradient carousel -> FAQ -> closing CTA), with
// the same tokens, type scale, spacing, animations and hover effects.
...
/* ===============================================================
   BRAND TOKENS — identical to the other capability detail pages
================================================================ */
...
const SERVICE_BASE = "/services/freshService";
...
const processSteps = [
  {
    icon: Search,
    title: "Assess",
    body: "We audit your current service desk, ticket volume, and ITSM maturity to understand where process breaks down before any configuration is proposed.",
  },
  {
    icon: Settings,
    title: "Configure",
    body: "Service desk, workflows, roles, and SLAs are configured and validated against your real processes, not a generic out of the box default.",
  },
  {
    icon: ArrowRightLeft,
    title: "Migrate & Automate",
    body: "Historical tickets, assets, and CMDB data move in with integrity checked, while automation rules take over the repetitive triage work.",
  },
  {
    icon: LifeBuoy,
    title: "Optimize & Support",
    body: "We monitor adoption after go live and keep tuning configuration and automation as ticket volume and team structure evolve.",
  },
];

/* ===============================================================
   GLOBAL KEYFRAMES — same CSS as the other capability detail pages
================================================================ */
...
export default async function CapabilityDetailPage({
  ...
  // Everything else in the "Freshservice" capability grid.
  ...
  return (
    <main className="bg-white">
      ...
      {/* ============================================================
          HERO — identical to the other capability detail page heroes
      ============================================================ */}
      ...
      <div className={ALIGN}>
        {/* ============================================================
            OVERVIEW — same block as the other capability "Q&A" sections
        ============================================================ */}
      ...
      {/* ============================================================
          KEY FEATURES — same as the other pages' capability cards
      ============================================================ */}
      <section
        id="features"
          ...
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[380px_1fr] lg:gap-14 xl:grid-cols-[420px_1fr]">
            <Reveal className="self-start lg:sticky lg:top-28">
              ...
              <p className="font-body mt-5 max-w-md text-[15px] leading-relaxed text-slate-600 sm:text-[16px]">
                A closer look at what Starfii configures and supports under{" "}
                {capability.title.toLowerCase()}, so your IT team can trust
                and run on Freshservice with confidence.
              </p>
            </Reveal>
      ...
      {/* ============================================================
          HOW WE DELIVER — same dark section as the other pages
      ============================================================ */}
      ...
      {/* ============================================================
          OTHER CAPABILITIES — same as the other pages' "Case Studies"
      ============================================================ */}
      <OtherCapabilities
      ...
      {/* ============================================================
          FAQ — same section as the other capability FAQs
      ============================================================ */}
      <section
        id="faq"
