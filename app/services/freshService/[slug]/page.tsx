...
/* Route used for the breadcrumb and the CTA. Your old BASE_PATH was
   "/services/freshService", which looked like a copy paste leftover. */
const GCC_PATH = "/services/global-capability-centers";

/* ---------- static GCC copy (kept from the previous page) ---------- */

const GLANCE_GROUPS = [
  {
    title: "Set Up",
    text: "Establish the right entity, infrastructure, compliance framework, and operating foundation for your Global Capability Center.",
  },
  {
    title: "Build",
    text: "Build the right talent model, hiring plan, onboarding process, governance structure, and collaboration model.",
  },
  {
    title: "Scale",
    text: "Scale from the first cohort to steady state operations with phased headcount, knowledge transfer, governance, and measurable outcomes.",
  },
];

const GLANCE_TAGLINE =
  "A Global Capability Center partner, Starfii helps enterprises establish, operate, and scale GCCs with talent, technology, governance, compliance, and delivery capabilities connected from day one.";

const CHALLENGE_POINTS = [
  "Establish the right operating model without creating unnecessary complexity.",
  "Build the right talent and capability mix for the GCC mandate.",
  "Maintain strong governance and alignment with global headquarters.",
  "Create a foundation that can scale as the GCC grows.",
];
...
const SOLUTION_GROUPS = [
  {
    title: "GCC Setup",
    points: [
      "Entity formation, infrastructure, operational readiness, and local setup sequenced as one connected program.",
    ],
  },
  {
    title: "Talent Strategy",
    points: [
      "Role architecture, hiring, onboarding, and capability development aligned to the GCC mandate.",
    ],
  },
  {
    title: "Governance & Compliance",
    points: [
      "Clear decision rights, reporting lines, security, compliance, and operational controls from the start.",
    ],
  },
  {
    title: "Scale & Transition",
    points: [
      "Phased headcount growth, knowledge transfer, delivery transition, and steady state operating support.",
    ],
  },
];
...
const APPROACH =
  "Build the capability first. Scale the operation second. Optimize continuously.";
...
function Breadcrumb({ title }: { title: string }) {
  return (
    ...
    >
      ...
      <ChevronRight className="h-3.5 w-3.5" />
      <Link href={GCC_PATH} className="hover:text-[#3a3ff0]">
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      ...
      <div className="rounded-2xl bg-[#0b1747] p-6">
        ...
        <p className="font-body mt-1.5 text-[15px] text-slate-300">
          From entity setup and talent strategy to governance and operational
          scale.
        </p>
        <Link
          href={`${GCC_PATH}#connect`}
          ...
          <div className="min-w-0">
            ...
            <div className="mt-10">
              ...
              <section id="client" className="scroll-mt-28">
                ...
                <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3">
                  {[
                    ...
                    { value: study.duration, label: "Engagement" },
                  ].map((tile) => (
                    <div key={tile.label}>
                ...
                <h2 className={`${SUB_HEADING} mt-12`}>
                  Global Capability Center at a Glance
                </h2>
                <div className="mt-6 space-y-8">
                  {GLANCE_GROUPS.map((g) => (
                    <div key={g.title}>
                      <h2 className="font-heading text-[18px] font-semibold leading-snug text-[#0b1747] sm:text-[20px]">
                        {g.title}
                      </h2>
                      <BulletCard points={[g.text]} />
                    </div>
                  ))}
                </div>
                <Paragraphs items={[GLANCE_TAGLINE]} />
              </section>
              ...
              <section id="challenge" className="mt-20 scroll-mt-28">
                ...
                <BulletCard points={CHALLENGE_POINTS} />
              </section>
              ...
              <section id="solution" className="mt-20 scroll-mt-28">
                ...
                <GroupList groups={SOLUTION_GROUPS} />
              </section>
              ...
              <section id="benefits" className="mt-20 scroll-mt-28">
                ...
                <div className="mt-8">
                  ...
                  <BulletCard points={BENEFIT_POINTS} />
                </div>
              </section>
              ...
              <section id="summary" className="mt-20 scroll-mt-28">
                ...
                <h2 className={`${SUB_HEADING} mt-10`}>The Starfii approach</h2>
                <BulletCard points={[APPROACH]} />
              </section>
            </div>
          </div>
