...
} from "../data.tsx/casestudies"; // your folder name, kept as is
...
/* Static cloud foundation copy (kept from the previous page) */
const CLOUD_INTRO =
  "This cloud engineering engagement focused on creating a stronger, more scalable, secure, and operationally mature foundation for the organization.";

const CLOUD_TILES = [
  { label: "Cloud", value: "Modern foundation" },
  { label: "Security", value: "Secure by design" },
  { label: "Operations", value: "Automated workflows" },
];

const CLOUD_FOUNDATION = [
  {
...
/** White rounded card with text, used for solution groups and benefits */
    ...
    <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
      <div className="rounded-2xl bg-white p-6">
        ...
        <dl className="mt-5 space-y-4">
          ...
          <div>
            <dt className="font-body text-[14px] text-slate-500">
              Cloud services
            </dt>
          ...
          <div className="min-w-0">
            ...
            <div className="mt-10">
              ...
              <section id="client" className="scroll-mt-28">
                ...
                <Paragraphs items={[study.overview, CLOUD_INTRO]} />

                <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-3">
                  {CLOUD_TILES.map((tile) => (
                    <div key={tile.label}>
