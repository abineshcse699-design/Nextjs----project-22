// app/services/cloud/capabilities/[slug]/page.tsx
//
...
// in structure to app/services/data-analytics/capabilities/[slug]/page.tsx.
...
const SERVICE_BASE = "/services/cloud";
const CAPABILITY_BASE = "/services/cloud/capabilities";
...
const processSteps = [
  {
    icon: Search,
    title: "Assess",
    body: "We audit your current environment, workloads, and operational processes to understand where the cloud estate stands before any new architecture is proposed.",
  },
  {
    icon: PenTool,
    title: "Architect",
    body: "Landing zones, network topology, and governance rules are planned and validated with your team before a single workload moves or is built.",
  },
  {
    icon: Code2,
    title: "Automate & Build",
    body: "Our cloud engineers ship infrastructure as code, pipelines, and platforms in short, visible increments, so you see progress early, not just at the end.",
  },
  {
    icon: Rocket,
    title: "Operate & Optimize",
    body: "We support the environment post launch, monitoring reliability, cost, and security as workloads, teams, and traffic grow.",
  },
];
...
export default async function CapabilityDetailPage({
  ...
  // Everything else in the "Cloud Engineering" grid.
