// app/services/digital-software/blogs/BlogDetail.tsx  (Software & Product)
...
/* ============================================================
   SERVICE LABEL + ROUTES — change here only, used across the page
============================================================ */

const SERVICE_NAME = "Software & Product";
const SERVICE_HREF = "/services/digital-software";
const BLOGS_HREF = `${SERVICE_HREF}/blogs`;

const COPY = {
  bodyHeading: "Software & Product Engineering in Practice",
  benefitsHeading: "Why modern software engineering matters",
  benefitsIntro:
    "The strongest engineering programs connect technology improvements to measurable product, delivery, and business outcomes.",
  processHeading: "A practical software delivery journey",
  takeawaysHeading: "Key engineering takeaways",
  conclusionHeading: "Final perspective",
  sidebarMoreHeading: "More engineering insights",
  bottomMoreHeading: "Explore more Software & Product insights",
};
      ...
      <section className="bg-gradient-to-b from-[#cfe3f2] via-[#e1ecf6] to-[#eef0f5] pb-10 pt-28 sm:pt-32">
        <div className={ALIGN}>
          ...
          >
            ...
            <Link href={SERVICE_HREF} className="hover:text-[#4F3FE0]">
              {SERVICE_NAME}
            </Link>
            <ChevronRight size={14} />
            ...
            <article className="min-w-0">
              ...
              {post.keyTakeaways && post.keyTakeaways.length > 0 && (
                <section className="mt-20 rounded-2xl bg-[#F5F3FC] p-7 sm:p-10">
                  <h2 className={SECTION_HEADING}>{COPY.takeawaysHeading}</h2>
              ...
              {post.conclusion && (
                <section className="mt-20">
                  <div className="rounded-2xl bg-[#EAE4FA] p-8 sm:p-10 lg:p-12">
                    <h2 className={SECTION_HEADING}>{COPY.conclusionHeading}</h2>
                ...
                {related.length > 0 && (
                  <div className="rounded-2xl border border-slate-200 bg-white p-6">
                    <div className="flex items-center justify-between gap-4">
                      <h2 className={SUB_HEADING}>{COPY.sidebarMoreHeading}</h2>
                      <Link
                        href={BLOGS_HREF}
        ...
        <section className="mt-24 bg-[#EEF0F5] py-24">
          <div className={ALIGN}>
            <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
              <h2 className={SECTION_HEADING}>{COPY.bottomMoreHeading}</h2>
