...
export async function generateMetadata({
  ...
  return {
    title: `${study.title} | Starfii Business Process Services Case Study`,
...
export default async function BusinessProcessCaseStudyPage({
   ...
   * next 4 related case studies show pannum.
   */
        ...
        <section className="py-20 lg:py-24">
          ...
          <div className="mb-10 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            ...
            <div>
              ...
              >
                Measurable improvements across business operations
              </h2>

            </div>

            <p className="max-w-md text-[15px] leading-7 text-slate-500">
              Better processes help organizations reduce operational
              effort, improve service quality, accelerate workflows,
              and create more consistent business outcomes.
            </p>
        ...
        <section className="border-t py-20 lg:py-24">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-24">
            ...
            <div>
              ...
              >
                Transforming complex processes into simpler operations
              </h2>
        ...
        <section className="pb-24">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            >
              ...
              >
                From manual complexity to process clarity
              </h2>
            ...
            >
              ...
              >
                Redesigning workflows for smarter delivery
              </h2>
        ...
        >
          ...
          <div className="grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
            ...
            <div>
              ...
              >
                Capabilities designed around better business outcomes
              </h2>

              <p className="mt-5 max-w-lg text-[15px] leading-7 text-slate-600">
                Starfii helps organizations optimize business processes
                through workflow redesign, intelligent automation,
                operational support, and data-driven process improvement.
              </p>
          ...
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-3 text-[14px] leading-7 text-slate-600">
                Identify process bottlenecks, simplify workflows, and
                create more efficient operating models across business
                functions.
              </p>
            ...
            <div>
              ...
              <p className="mt-3 text-[14px] leading-7 text-slate-600">
                Automate repetitive tasks and workflows to reduce manual
                effort, improve consistency, and accelerate service
                delivery.
              </p>
            ...
            <div>
              ...
              <p className="mt-3 text-[14px] leading-7 text-slate-600">
                Deliver consistent, measurable, and scalable business
                services that improve experiences for customers and
                internal teams.
              </p>
        ...
        <section className="py-20 lg:py-24">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p className="mt-3 text-[14px] leading-7 text-slate-600">
                Connect people, processes, and systems through structured
                workflows that improve visibility and execution.
              </p>
            ...
            >
              ...
              <p className="mt-3 text-[14px] leading-7 text-slate-600">
                Establish clear controls, standards, and accountability
                to make business processes more consistent and reliable.
              </p>
            ...
            >
              ...
              <p className="mt-3 text-[14px] leading-7 text-slate-600">
                Use operational metrics and reporting to understand
                process performance and continuously improve outcomes.
              </p>
          ...
          >
            ...
            <div className="relative flex flex-col justify-between gap-9 lg:flex-row lg:items-center">
              ...
              <div className="max-w-2xl">
                ...
                <p className="mt-5 text-[15px] leading-7 text-slate-600">
                  Talk to our Business Process Services team about
                  process optimization, workflow automation, operational
                  support, service delivery, or business transformation.
                </p>
