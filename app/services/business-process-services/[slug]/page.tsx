...
const BASE_PATH = "/services/business-process-services";
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className={`${ALIGN} py-20 lg:py-28`}>
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[14px] font-medium" style={{ color: CHAMPION_BLUE }}>
            ...
            <Link href="/services/business-process-services" className="hover:underline">Business Process Services</Link>
            <ChevronRight size={14} />
      ...
      <div className={ALIGN}>
        ...
        <div className="pb-16">
          <Link href="/services/business-process-services" className="inline-flex items-center gap-2 text-[14px] font-semibold" style={{ color: INDIGO_CTA }}>
            <ArrowLeft size={16} />
