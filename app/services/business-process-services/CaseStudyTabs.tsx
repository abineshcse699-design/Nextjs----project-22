...
export default function CaseStudyTabs() {
  ...
  return (
    <nav
      aria-label="Business Process case study sections"
        ...
        {TABS.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <span
                aria-hidden="true"
                className={`absolute inset-x-4 bottom-0 h-[2px] rounded-full bg-[#4F3FE0] transition-opacity duration-300 sm:inset-x-5 ${
                  isActive
                    ? "opacity-100"
                    : "opacity-0"
                }`}
