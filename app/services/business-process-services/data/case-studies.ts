...
export const caseStudies: CaseStudyDetail[] = [
  {
    ...
    title:
      "Starfii Cuts Days Sales Outstanding for a Global Manufacturer",
...

  {
    ...
    title:
      "Starfii Transforms Procure-to-Pay for a National Retailer",
...

  {
    ...
    title:
      "Starfii Modernizes Revenue Cycle Management for a Hospital Network",
...

  {
    ...
    title:
      "Starfii Shortens Month End Close for a National Insurer",
    ...
    results: [
      ...
      {
        metric: "100%",
        label: "Business units standardized",
      },
    ],
...

  {
    ...
    title:
      "Starfii Runs Customer Operations for a Telecom Provider at Scale",
    ...
    results: [
      ...
      {
        metric: "26%",
        label: "Lower average handling time",
      },
      {
        metric: "24/7",
        label: "Managed operations coverage",
      },
    ],
