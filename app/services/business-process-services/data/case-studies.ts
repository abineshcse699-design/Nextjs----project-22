...
const rawCaseStudies: CaseStudyDetail[] = [
...

  {
    ...
    {
    slug: "abinesh-business-process-automation",
    ...
    title:
      "Starfii Automates Back Office Operations for Abinesh",

    subtitle:
      "See how Starfii redesigned Abinesh's back office workflows and introduced RPA to cut manual processing time and standardize exception handling.",

    cardDescription:
      "Starfii redesigned back office workflows and introduced RPA to cut manual processing time for Abinesh.",
    ...
    overview:
      "Abinesh's back office operations relied on manual data entry and inconsistent handoffs across teams, slowing turnaround on routine transactions.",

    clientOverview:
      "Abinesh's operations team processed a high volume of routine back office transactions manually, with no standardized workflow across teams. Exceptions were handled case by case, creating delays and inconsistent outcomes.",

    challengeIntro:
      "Abinesh needed a standardized back office process that could handle rising transaction volume without adding headcount.",

    challengePoints: [
      "Manual data entry: Routine transactions were processed by hand across scattered systems.",

      "Inconsistent handoffs: No standardized workflow existed between teams handling the same transaction types.",

      "Ad hoc exceptions: Exception cases were resolved inconsistently, with no defined ownership.",

      "Limited visibility: Leadership had no single view of transaction throughput or backlog.",
    ],

    solutionIntro:
      "Starfii redesigned Abinesh's back office workflow around one standardized process and automated the repetitive steps.",

    solutionDetail:
      "The solution combined process redesign, robotic process automation for routine data entry, standardized exception routing, and managed operations support against defined turnaround targets.",

    solution: [
      "Process redesign: Back office workflows were mapped and consolidated into a single standardized process.",

      "RPA for data entry: Repetitive transaction entry was automated across the core systems involved.",

      "Exception routing: Exceptions were routed through a standardized workflow with clear ownership.",

      "Managed operations: Starfii's team supported day to day execution against agreed turnaround targets.",
    ],

    results: [
      { metric: "33%", label: "Faster transaction turnaround" },
      { metric: "48%", label: "Less manual data entry" },
      { metric: "27%", label: "Lower backlog volume" },
    ],

    benefitsIntro:
      "The redesigned back office operation gave Abinesh a faster, more consistent, and more visible transaction process.",

    benefits: [
      "Faster turnaround: Standardized workflows move transactions through the process more quickly.",

      "Lower manual effort: RPA removed repetitive data entry work from the team.",

      "Consistent exception handling: Clear ownership reduced case by case variation.",

      "Better visibility: Leadership can now see throughput and backlog in one place.",
    ],

    summary:
      "Starfii transformed Abinesh's back office operation into a standardized and partially automated process, helping the team cut turnaround time, reduce manual data entry, and clear backlog faster.",
    ...
    date: "2026-09-11",   // ⚠️ latest date — pushes this to #1 everywhere
  },
];
