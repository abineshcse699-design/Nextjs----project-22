...
const insights: InsightPost[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=1200&auto=format&fit=crop",
    title: "Why Automating a Broken Process Just Moves the Breakage Somewhere Else",
  ...
  },
  {
    ...
    body: "See how better process design removes unnecessary handoffs, duplicate approvals, and rework before automation is introduced.",
  },
  {
    large: false,
    image:
    ...
    body: "Explore how managed business operations use clear SLAs, dashboards, and continuous improvement to keep service performance on track.",
  },
];
      ...
      >
        <div className={ALIGN}>
          <Reveal className="flex items-center justify-between">
            ...
            <Link
              href="/services/business-process-services/case-studies"
          ...
          <div className="mt-12">
            <StepCarousel
              ...
              renderItem={(study, i) => (
               ...
               <Link
  href={`/services/business-process-services/${study.slug}`}
          ...
          <div className="mt-12">
            ...
            >
              {insights.map((post, i) => (
                ...
                >
                  <Link
                    href={`/services/business-process-services/blogs/${post.slug}`}
                    className="block"
                  >
                    {post.large ? (
