...
const BASE_PATH = "/services/enterprise-platform-services";
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className={`${ALIGN} py-20 lg:py-28`}>
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[14px] font-medium" style={{ color: CHAMPION_BLUE }}>
            ...
            <Link href={BASE_PATH} className="hover:underline">Enterprise Platform Services</Link>
            <ChevronRight size={14} />
      ...
      <div className={ALIGN}>
        ...
        <div className="pb-16">
          <Link href={BASE_PATH} className="inline-flex items-center gap-2 text-[14px] font-semibold" style={{ color: INDIGO_CTA }}>
            <ArrowLeft size={16} />
