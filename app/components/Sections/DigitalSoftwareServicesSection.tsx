...
import GetInTouch from "../../services/software-product/GetInTouch";
import {
  useRef,
  useState,
  useEffect,
...
const caseStudies: CaseStudy[] = [
  {
    ...
    body: "See how Starfii shipped a production-ready AI assistant inside an existing support product, cutting agent handling time while keeping customer data private.",
  },
  {
    ...
    title: "Re-Architecting a Legacy ERP into a Multi-Tenant SaaS Platform",
    body: "Learn how Starfii moved an on-premise ERP product to a multi-tenant SaaS platform, cutting onboarding from months to days.",
  },
  {
    ...
    body: "See how Starfii took a fintech payments product from idea to launch in five months and scaled it to millions of transactions.",
  },
  {
    ...
    body: "Discover how Starfii automated testing and deployment for a software product team, moving from monthly releases to several a week.",
  },
  {
    ...
    body: "See how Starfii combined UX research and front-end engineering to redesign an analytics product and lift activation and retention.",
  },
];
...
<section
  id="overview"
  className="relative isolate min-h-[460px] overflow-hidden lg:min-h-[620px]"
>
