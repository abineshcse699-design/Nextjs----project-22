...
//         <div className="relative mx-auto grid max-w-[1320px] grid-cols-1 items-center gap-16 px-6 sm:px-10 lg:grid-cols-2 lg:px-16">
//           <div>
//             <Reveal>
...
//         <div className="relative mx-auto grid max-w-[1320px] grid-cols-1 gap-16 px-6 sm:px-10 lg:grid-cols-[0.9fr_1.1fr] lg:px-16">
//           <Reveal>
...
//       {/* ---------------- FAQ ---------------- */}
//       <section className="relative py-20 lg:py-28">
//         <div className="relative mx-auto max-w-[880px] px-6 sm:px-10 lg:px-16">
