...
const tabs: ServiceTab[] = [ { label: "Architecture: Design for Scale", heading: "Cloud architecture blueprints built for scale, security, and cost, before migration begins", body: "Starfii designs landing zones, network topology, and account structure across AWS, Azure, and GCP up front, so every workload that moves in has a foundation built to last. We define the right compute, storage, networking, identity, and governance patterns based on your workloads, business requirements, compliance needs, and long term growth plans. Our architecture approach considers how applications communicate, where data should reside, how users and services should access resources, and how environments should be separated across development, staging, and production. We establish clear standards for resource organization, naming, access control, connectivity, monitoring, backup, and disaster recovery before workloads begin moving into the cloud. This creates a consistent foundation that reduces architectural drift and avoids costly redesigns later. As your environment grows, new applications and teams can follow the same proven patterns instead of creating isolated infrastructure. The result is a cloud architecture that is easier to manage, secure, optimize, and scale while giving engineering and business teams a clear technical foundation for future growth.", image: "[https://images.unsplash.com/photo-1518770660439-4636190af475?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1518770660439-4636190af475?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "Migration: Plan a Move That Fits", heading: "A cloud migration roadmap sequenced around business risk, not just technical ease", body: "Starfii assesses your workloads and builds a cloud migration plan that moves the right systems in the right order, so the business keeps running while the cloud foundation gets built underneath it. We start by understanding your existing infrastructure, applications, databases, integrations, dependencies, operational processes, and business-critical workloads. Each application is evaluated to determine whether it should be rehosted, replatformed, refactored, retired, or retained based on its technical condition and business value. We map application dependencies and identify systems that require special attention because of data sensitivity, availability requirements, licensing constraints, performance expectations, or integration complexity. From there, we define migration waves with clear prerequisites, validation steps, rollback considerations, testing requirements, and ownership. This allows teams to start with practical workloads, learn from early migration waves, and apply those lessons to more complex systems. We also consider network connectivity, identity, security, data transfer, backup, disaster recovery, monitoring, and operational readiness as part of the migration plan rather than treating them as afterthoughts. The result is a practical migration roadmap that reduces disruption, exposes risks early, improves visibility across the program, and provides a structured path from legacy infrastructure to a scalable and manageable cloud environment.", image: "[https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "Modernize: Cloud Native by Design", heading: "Applications modernized and engineered for the cloud, not just moved onto it", body: "Starfii helps organizations move beyond simply relocating existing applications and instead identifies where modernization can deliver meaningful business and technical value. We assess legacy applications, architectures, databases, integrations, deployment processes, and operational constraints to determine where modernization is genuinely worthwhile. Where appropriate, we refactor applications using containers, microservices, managed services, APIs, event driven architectures, and serverless technologies to improve scalability, resilience, deployment speed, and operational flexibility. We also recognize that not every application needs to be rebuilt. Some workloads can deliver the required business outcome through a simpler migration approach, and we avoid introducing unnecessary architectural complexity where it does not create measurable value. For applications that require deeper transformation, we establish modernization roadmaps that break large changes into manageable stages while maintaining business continuity. We design applications to make better use of cloud capabilities such as elastic compute, managed databases, automated scaling, distributed systems, and fault tolerant infrastructure. This approach creates application environments that can respond to changing demand, recover more reliably from failures, support faster development cycles, and evolve as business requirements change. The result is a cloud application portfolio designed around long term flexibility rather than simply reproducing legacy infrastructure in a new location.", image: "[https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "DevOps & CI/CD: Ship Faster, Safer", heading: "DevOps culture and CI/CD pipelines that get code to production faster, without sacrificing stability", body: "Starfii brings development, infrastructure, security, and operations closer together through automated delivery processes designed around reliability and repeatability. We build CI/CD pipelines that automate source validation, compilation, testing, security checks, artifact management, deployment, and release processes across development, staging, and production environments. Automated testing is incorporated into the delivery workflow so issues can be detected earlier rather than after changes reach production. We also establish deployment strategies such as rolling releases, blue-green deployments, canary releases, and automated rollback where they make sense for the application. Environment configuration is standardized to reduce the differences between development and production and to make releases more predictable. Infrastructure and application changes can be tracked through version control, reviewed by the appropriate teams, and deployed through repeatable workflows instead of manual processes. We integrate monitoring and release validation into the deployment lifecycle so teams can quickly determine whether a new release is behaving as expected. By reducing manual intervention and improving visibility throughout the delivery process, engineering teams can release features and fixes more frequently while maintaining stronger operational controls. The result is a delivery model that improves developer productivity, shortens release cycles, reduces deployment risk, and creates a more reliable path from code commit to production.", image: "[https://images.unsplash.com/photo-1556761175-b413da4baf72?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1556761175-b413da4baf72?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "Automation: Infrastructure as Code", heading: "Infrastructure provisioned as code, so environments stay consistent and repeatable", body: "Starfii uses Infrastructure as Code to replace manual infrastructure provisioning with version controlled, repeatable, and auditable workflows. Using Terraform and native cloud tooling where appropriate, we codify networking, compute, storage, identity, security controls, databases, monitoring resources, and other infrastructure components so environments can be created consistently across accounts, regions, and stages. Infrastructure definitions can be reviewed through standard development workflows, allowing teams to understand exactly what will change before it is applied. Changes are tracked in version control, making it easier to audit infrastructure decisions, identify configuration history, and roll back changes when necessary. We create reusable modules and patterns that allow teams to provision new environments without rebuilding infrastructure manually from scratch. This helps reduce configuration drift between development, staging, and production while improving consistency across large cloud estates. Automated validation can also be incorporated into infrastructure workflows to identify incorrect configurations before they reach production. As organizations expand into additional accounts, regions, applications, or cloud providers, Infrastructure as Code provides a scalable operating model for managing that growth. The result is faster provisioning, fewer manual errors, stronger governance, easier disaster recovery, and infrastructure that can evolve alongside the organization without becoming increasingly difficult to manage.", image: "[https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "Observability: See Issues Before Impact", heading: "Monitoring and observability that surfaces problems before they become incidents", body: "Starfii builds observability into cloud environments so engineering and operations teams can understand system health, identify abnormal behavior, and respond to issues before they create significant business impact. We bring together metrics, logs, traces, application telemetry, infrastructure signals, and service health indicators across your cloud estate to create a more complete view of how systems are performing. Rather than generating large volumes of alerts that create unnecessary noise, we help define meaningful thresholds, service level indicators, and actionable alerts around the systems and business processes that matter most. Application and infrastructure dependencies can be mapped so teams can quickly understand how an issue in one component may affect another. Dashboards provide visibility into performance, resource utilization, availability, error rates, latency, capacity, and other operational indicators. Centralized logging and distributed tracing help engineers investigate complex issues across applications and services without relying on isolated infrastructure data. We also establish escalation and incident response workflows so teams know what action to take when critical conditions occur. Over time, observability data can be used to identify recurring problems, capacity trends, performance bottlenecks, and opportunities for optimization. The result is a more proactive operating model where teams spend less time discovering problems after users are affected and more time preventing incidents and improving system reliability.", image: "[https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "Security: Secure by Design", heading: "Cloud security built into the architecture, not added after launch", body: "Starfii embeds security controls into cloud architecture, infrastructure, application delivery, and operational processes from the beginning rather than treating security as a final review step. We establish identity and access management patterns based on least privilege, role separation, workload requirements, and organizational responsibilities. Network security is designed around appropriate segmentation, private connectivity, controlled ingress and egress, and clearly defined trust boundaries. We incorporate encryption, secrets management, logging, security monitoring, backup protection, and policy controls according to the sensitivity and regulatory requirements of each workload. Security policies can be integrated into Infrastructure as Code and CI/CD workflows so infrastructure and application changes are evaluated consistently throughout the delivery lifecycle. We also consider account structure, environment separation, administrative access, privileged operations, and centralized security visibility when designing the cloud foundation. Where compliance requirements apply, controls can be mapped to the relevant operational and technical requirements so teams have a clearer understanding of how security practices are implemented across the environment. Our approach is designed to balance protection with usability, ensuring security controls support engineering teams instead of unnecessarily slowing development. By making security part of the architecture and deployment process, organizations can reduce exposure, improve consistency, strengthen operational visibility, and create a cloud environment that can scale without allowing security practices to fall behind growth.", image: "[https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, { label: "Managed Services: Run With Confidence", heading: "Cloud operations and managed services that keep environments running around the clock", body: "Starfii provides ongoing cloud operations and SRE-led managed services designed to keep infrastructure reliable, secure, observable, and ready to support business growth. Our operations teams monitor cloud environments across AWS, Azure, and GCP, helping organizations manage infrastructure health, performance, availability, capacity, patching, backups, and operational changes. We support incident response processes that help teams identify the source of problems, restore services, and capture lessons that can reduce the chance of recurring incidents. Regular operational reviews can be used to identify underutilized resources, configuration issues, performance bottlenecks, security gaps, and opportunities for cost optimization. We also help maintain operational standards across accounts, environments, and workloads so cloud management does not become fragmented as the environment grows. Monitoring and alerting are continuously reviewed to ensure teams receive useful signals rather than unnecessary noise. Where automation can reduce repetitive operational work, we introduce automated remediation, scheduled maintenance, infrastructure workflows, and standardized runbooks. Our SRE-led approach focuses not only on keeping systems running today but also on improving reliability over time through better processes, automation, observability, and engineering practices. With continuous operational oversight, organizations gain additional cloud expertise and operational capacity while their internal teams remain focused on product development, customer experience, and strategic business priorities.", image: "[https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=90&w=1400&auto=format&fit=crop](https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=90\\&w=1400\\&auto=format\\&fit=crop)", }, ];
      ...
      <div className={ALIGN}>
        ...
        <Reveal as="section" className="mt-20 mb-20 lg:mb-24">
          <div
            ...
            className="group grid grid-cols-1 items-stretch overflow-hidden rounded-[20px] bg-[#F5F3FC] transition-colors duration-500 ease-out hover:bg-[#EAE4FA] lg:grid-cols-2">
