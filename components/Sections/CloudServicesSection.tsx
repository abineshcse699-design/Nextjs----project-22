        ...
        <div className={ALIGN}>
          ...
          >
            ...
            <p className="font-body mx-auto mt-5 max-w-xl text-[15px] leading-relaxed text-white/70">
              Talk to Starfii about cloud architecture, migration,
              modernization, DevOps, CI/CD, infrastructure as code,
              security, FinOps, observability, or managed cloud operations.
            </p>
            <a
