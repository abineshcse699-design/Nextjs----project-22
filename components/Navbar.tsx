...
export default function Navbar() {
  ...
  return (
    <>
      {/* =========================================================
          FIXED NAVBAR
          Full-width white wrapper prevents page content from
          showing behind the navbar while scrolling.
      ========================================================= */}
<header
  onMouseLeave={scheduleClose}
  className="fixed left-0 right-0 top-0 z-[99999] block"
>
  {/* This layer ALWAYS stays visible */}
  <div className="relative z-[99999] w-full bg-white">
    <nav className="relative mx-auto max-w-[1600px] px-4 py-4 sm:px-6 lg:px-8">
      <div
        className="
          relative
          z-[99999]
    ...
    <div>
      ...
      >
        ...
        >
          ...
          and transformation. Explore the platform behind Hexaware&apos;s
          Zero Friction Enterprise™.
        </p>
  ...
  const articles = [
    {
      ...
      gradient:
        "from-[#0B63F6] via-[#3B82F6] to-[#22C55E]",
    },
    {
      label: "Featured Insight",
      title:
...
function CareersMenu() {
  const cards = [
    {
      title: "Why Join Hexaware?",
      desc:
        "Build your career with opportunities to learn, grow, and contribute.",
    },
    {
    ...
    >
      ...
      >
        ...
        <p
          ...
          "
        >
          Ready to own your game with Hexaware? Look for open positions
          now!
        </p>
