 ...
 * Footer
 * -------
 * Site-wide footer: italic wordmark, 5-column link grid
...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-white to-[#dbe6fb] px-6 pb-8 pt-16 md:px-16 lg:pt-20">
      <a href="/" className="inline-block" aria-label="Hexaware home">
        <span
          className="inline-block -skew-x-[10deg] text-3xl font-black italic tracking-tight text-[#3a3ff0] md:text-4xl"
        >
          HEXAWARE
        </span>
      </a>
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        <p className="text-sm text-slate-500">
          © {new Date().getFullYear()} Hexaware Technologies. All rights reserved.
        </p>
